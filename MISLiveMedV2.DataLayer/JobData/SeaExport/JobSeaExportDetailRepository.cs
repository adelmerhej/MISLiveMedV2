...
namespace MISLiveMed.DataLayers.JobData.SeaExport
{
    ...
    {
        public IList<JobSeaExportDetailsModel> JobsSeaExportDetail(bool showProtected = false)
        {
            try
            {
                using (IDbConnection connection = new SqlConnection(ConnectionHelper.BuildConnectionString()))
                {
                    ...
                    var jobsList =
                        connection.Query<JobSeaExportDetailsModel>("SELECT * FROM JobSExportDetail " +
