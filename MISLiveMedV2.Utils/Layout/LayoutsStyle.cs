...
namespace MISLiveMed.Utils.Layout
{
	public static class LayoutsStyle
	{
		private static readonly string _companyFolder = "MISLive";
		...
		public static bool ResetLayoutMenu(string accordion, string userName)
		{
			...
			//string fullPath = Path.Combine(folder1, folder2, folder3);

			// Prepare directory
			string directoryPath = Path.Combine(GetFolderPath(SpecialFolder.ApplicationData), _companyFolder, _layoutsFolder, userName);
