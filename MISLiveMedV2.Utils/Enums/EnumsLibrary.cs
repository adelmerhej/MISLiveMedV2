...
namespace MISLiveMed.Utils.Enums;
...
public enum ConditionSelection
{
	ToBeLoaded = 1,
	OnWater = 2
}
...
{
	AirExport = 2,
	FairsAndExhibition = 3,
	PackingAndRemovals = 4,
	AirImport = 5,
	LandFreight = 6,
	Management = 7,
	AirClearance = 8,
...
// Replace string constants with an enum for form/menu names
public enum FormNames
{
	NavigationMenu,
	MainAdministrationMenu,
	MainAccountingMenu,
	SetupMenu,
	...
	DebitNotesList,
	CreditNotesList,
	CommissionsHistoryList,
	ImportDepartmentMenu,
	JobSeaImportList,
	JobAirImportList,
	ExportDepartmentMenu,
	JobSeaExportList,
	JobAirExportList,
	CrossDepartment,
	JobSeaCrossList,
	...
	GroupReports,
	ClientsReportsGroup,
	ClientInvoicesDetailReport,
	InvoicesDetailReport,
	ClientsReport,
	ClientSalesReport,
	ImportDepartmentReports,
	ToBeLoadedSeaImport,
	OnWaterSeaImport,
	AirImportStatusReport,
	ExportDepartmentReports,
	ToBeLoadedSeaExport,
	OnWaterSeaExport,
	AirExportStatusReport,
	CrossDepartmentReports,
	PendingCrossReports,
	ClearanceDepartmentReports,
	JobClearanceReport,
	NegativeReport,
