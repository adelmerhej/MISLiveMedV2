...
{
    public partial class CostEditForm : RibbonForm
    {
	    private const string _formName = "CostEdit";
	    private int _formId;
		...
		public EventHandler SendUpdatedCost;

	    public CostEditForm(CostModel model)
	    {
		    InitializeComponent();
