...
namespace MISLiveMed.UI.Accounting.DebitNotes
{
	public partial class DebitNotesListForm : RibbonForm, IFormWithRibbon
	{
		private const string _formName = "DebitNotesList";
		private int _formId;
		...
		public RibbonControl MainRibbon => rcDebitNotes;
		public RibbonPage DefaultPage => rpDebitNotes;


		#endregion

		public DebitNotesListForm()
		{
			InitializeComponent();
