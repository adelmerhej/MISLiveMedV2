...
namespace MISLiveMed.UI.Accounting.Payments
{
    partial class PaymentDetailForm
    {
        ...
        private void InitializeComponent()
        {
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(PaymentDetailForm));
			...
			this.gcPaymentsDetail = new DevExpress.XtraGrid.GridControl();
			this.gvPaymentsDetail = new DevExpress.XtraGrid.Views.Grid.GridView();
			...
			((System.ComponentModel.ISupportInitialize)(this.gcPaymentsDetail)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.gvPaymentsDetail)).BeginInit();
			...
			this.btnSchedule.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(this.btnMeeting_ItemClick);
			// 
			// btnActionPay
			// 
			...
			this.btnActionPay.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(this.btnActionPay_ItemClick);
			// 
			// btnUndoPayment
			// 
			...
			this.btnUndoPayment.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(this.btnUndoPayment_ItemClick);
			// 
			// msgBarText
			// 
			...
			this.ribbonPage1.Text = "PAYMENT DETAIL";
			// 
			// ribbonPageGroup8
			// 
			...
			this.mainLayout.Controls.Add(this.gcPaymentsDetail);
			...
			// txtReference
			// 
			this.txtReference.DataBindings.Add(new System.Windows.Forms.Binding("EditValue", this.bsPayment, "ReferenceNo", true));
			...
			// gcPaymentsDetail
			// 
			this.gcPaymentsDetail.DataSource = this.bsPaymentDetails;
			this.gcPaymentsDetail.EmbeddedNavigator.Margin = new System.Windows.Forms.Padding(3, 5, 3, 5);
			this.gcPaymentsDetail.Location = new System.Drawing.Point(12, 353);
			this.gcPaymentsDetail.MainView = this.gvPaymentsDetail;
			this.gcPaymentsDetail.Margin = new System.Windows.Forms.Padding(3, 4, 3, 4);
			this.gcPaymentsDetail.Name = "gcPaymentsDetail";
			this.gcPaymentsDetail.RepositoryItems.AddRange(new DevExpress.XtraEditors.Repository.RepositoryItem[] {
            ...
            this.repPaidByusers});
			this.gcPaymentsDetail.Size = new System.Drawing.Size(1505, 307);
			this.gcPaymentsDetail.TabIndex = 4;
			this.gcPaymentsDetail.ViewCollection.AddRange(new DevExpress.XtraGrid.Views.Base.BaseView[] {
            this.gvPaymentsDetail});
			// 
			// gvPaymentsDetail
			// 
			this.gvPaymentsDetail.Columns.AddRange(new DevExpress.XtraGrid.Columns.GridColumn[] {
            this.colId,
            this.colPaymentId,
            this.colPaymentDate,
            this.colTypeId,
            ...
            this.colNotes,
            this.colDeleted});
			this.gvPaymentsDetail.DetailHeight = 431;
			this.gvPaymentsDetail.GridControl = this.gcPaymentsDetail;
			this.gvPaymentsDetail.Name = "gvPaymentsDetail";
			this.gvPaymentsDetail.OptionsBehavior.AllowAddRows = DevExpress.Utils.DefaultBoolean.True;
			this.gvPaymentsDetail.OptionsBehavior.AllowDeleteRows = DevExpress.Utils.DefaultBoolean.True;
			this.gvPaymentsDetail.OptionsNavigation.AutoFocusNewRow = true;
			this.gvPaymentsDetail.OptionsNavigation.EnterMoveNextColumn = true;
			this.gvPaymentsDetail.OptionsPrint.AutoWidth = false;
			this.gvPaymentsDetail.OptionsView.ColumnAutoWidth = false;
			this.gvPaymentsDetail.OptionsView.ShowFooter = true;
			this.gvPaymentsDetail.OptionsView.ShowGroupPanel = false;
			this.gvPaymentsDetail.PopupMenuShowing += new DevExpress.XtraGrid.Views.Grid.PopupMenuShowingEventHandler(this.gvPaymentsDetail_PopupMenuShowing);
			this.gvPaymentsDetail.CustomSummaryCalculate += new DevExpress.Data.CustomSummaryEventHandler(this.gvPaymentsDetail_CustomSummaryCalculate);
			this.gvPaymentsDetail.InitNewRow += new DevExpress.XtraGrid.Views.Grid.InitNewRowEventHandler(this.gvPaymentsDetail_InitNewRow);
			this.gvPaymentsDetail.CustomRowFilter += new DevExpress.XtraGrid.Views.Base.RowFilterEventHandler(this.gvPaymentsDetail_CustomRowFilter);
			this.gvPaymentsDetail.KeyUp += new System.Windows.Forms.KeyEventHandler(this.gvPaymentsDetail_KeyUp);
			// 
			// colId
			// 
			...
			// layoutControlItem1
			// 
			this.layoutControlItem1.Control = this.gcPaymentsDetail;
			this.layoutControlItem1.Location = new System.Drawing.Point(0, 341);
			this.layoutControlItem1.Name = "layoutControlItem1";
			this.layoutControlItem1.Size = new System.Drawing.Size(1509, 311);
			...
			this.emptySpaceItem3.Size = new System.Drawing.Size(1509, 13);
			...
			this.grpStatus.Location = new System.Drawing.Point(608, 158);
			this.grpStatus.Name = "grpStatus";
			this.grpStatus.Size = new System.Drawing.Size(901, 160);
			...
			this.layoutControlItem3.Location = new System.Drawing.Point(475, 82);
			...
			this.layoutControlItem4.Location = new System.Drawing.Point(577, 82);
			...
			this.emptySpaceItem2.Size = new System.Drawing.Size(877, 82);
			...
			this.emptySpaceItem4.Size = new System.Drawing.Size(901, 19);
			...
			this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.PaymentDetailForm_FormClosing);
			...
			((System.ComponentModel.ISupportInitialize)(this.gcPaymentsDetail)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.gvPaymentsDetail)).EndInit();
        ...
        private DevExpress.XtraGrid.GridControl gcPaymentsDetail;
        private DevExpress.XtraGrid.Views.Grid.GridView gvPaymentsDetail;
