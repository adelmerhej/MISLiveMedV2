...
namespace MISLiveMed.UI.Accounting.Journals
{
	partial class JournalsListForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.rcJournalsList = new DevExpress.XtraBars.Ribbon.RibbonControl();
			...
			this.repWorkingYear1 = new DevExpress.XtraEditors.Repository.RepositoryItemSearchLookUpEdit();
			...
			this.rpJournalsList = new DevExpress.XtraBars.Ribbon.RibbonPage();
			...
			((System.ComponentModel.ISupportInitialize)(this.rcJournalsList)).BeginInit();
            ...
            this.repFlowTypes,
            this.repChartList});
			this.gcJournals.Size = new System.Drawing.Size(1509, 542);
			...
			this.gcJournals.DoubleClick += new System.EventHandler(this.gcJournals_DoubleClick);
			// 
			// bsJournals
			// 
			this.bsJournals.DataSource = typeof(JournalModel);
			// 
			// gvJournals
			// 
			...
			this.gvJournals.MasterRowEmpty += new DevExpress.XtraGrid.Views.Grid.MasterRowEmptyEventHandler(this.gvJournals_MasterRowEmpty);
			this.gvJournals.MasterRowGetChildList += new DevExpress.XtraGrid.Views.Grid.MasterRowGetChildListEventHandler(this.gvJournals_MasterRowGetChildList);
			this.gvJournals.MasterRowGetRelationName += new DevExpress.XtraGrid.Views.Grid.MasterRowGetRelationNameEventHandler(this.gvJournals_MasterRowGetRelationName);
			this.gvJournals.MasterRowGetRelationCount += new DevExpress.XtraGrid.Views.Grid.MasterRowGetRelationCountEventHandler(this.gvJournals_MasterRowGetRelationCount);
			// 
			// colId
			// 
			...
			// rcJournalsList
			// 
			this.rcJournalsList.EmptyAreaImageOptions.ImagePadding = new System.Windows.Forms.Padding(35, 39, 35, 39);
			this.rcJournalsList.ExpandCollapseItem.Id = 0;
			this.rcJournalsList.Items.AddRange(new DevExpress.XtraBars.BarItem[] {
            this.rcJournalsList.ExpandCollapseItem,
            this.btnNew,
            this.btnDelete,
            this.btnEdit,
            this.btnPrint,
            ...
            this.dtFrom,
            this.dtTo});
			this.rcJournalsList.Location = new System.Drawing.Point(0, 0);
			this.rcJournalsList.Margin = new System.Windows.Forms.Padding(3, 4, 3, 4);
			this.rcJournalsList.MaxItemId = 66;
			this.rcJournalsList.MdiMergeStyle = DevExpress.XtraBars.Ribbon.RibbonMdiMergeStyle.Always;
			this.rcJournalsList.Name = "rcJournalsList";
			this.rcJournalsList.OptionsMenuMinWidth = 385;
			this.rcJournalsList.Pages.AddRange(new DevExpress.XtraBars.Ribbon.RibbonPage[] {
            this.rpJournalsList,
            this.rpViewSettings});
			this.rcJournalsList.RepositoryItems.AddRange(new DevExpress.XtraEditors.Repository.RepositoryItem[] {
            this.repWorkingYear1,
            this.repositoryItemDateEdit1,
            this.repositoryItemDateEdit2});
			this.rcJournalsList.Size = new System.Drawing.Size(1533, 193);
			this.rcJournalsList.StatusBar = this.ribbonStatusBar1;
			// 
			// btnNew
			// 
			...
			this.cboWorkingYear.Edit = this.repWorkingYear1;
			...
			// repWorkingYear1
			// 
			this.repWorkingYear1.AutoHeight = false;
			this.repWorkingYear1.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {
            new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
			this.repWorkingYear1.Name = "repWorkingYear1";
			this.repWorkingYear1.NullText = "";
			this.repWorkingYear1.PopupView = this.repositoryItemSearchLookUpEdit1View;
			// 
			...
			// rpJournalsList
			// 
			this.rpJournalsList.Groups.AddRange(new DevExpress.XtraBars.Ribbon.RibbonPageGroup[] {
			...
			this.rpJournalsList.Name = "rpJournalsList";
			this.rpJournalsList.Text = "JOURNALS";
			// 
			// ribbonPageGroup1
			// 
			...
			this.ribbonStatusBar1.Ribbon = this.rcJournalsList;
			this.ribbonStatusBar1.Size = new System.Drawing.Size(1533, 30);
			// 
			// mainLayout
			// 
			...
			this.mainLayout.Size = new System.Drawing.Size(1533, 566);
			...
			this.Root.Name = "Root";
			this.Root.Size = new System.Drawing.Size(1533, 566);
			...
			this.layoutControlItem1.Size = new System.Drawing.Size(1513, 546);
			...
			this.Controls.Add(this.rcJournalsList);
			this.Name = "JournalsListForm";
			this.Ribbon = this.rcJournalsList;
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.StatusBar = this.ribbonStatusBar1;
			this.Text = "Journals List";
			this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.JournalsListForm_FormClosing);
			...
			((System.ComponentModel.ISupportInitialize)(this.rcJournalsList)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.repWorkingYear1)).EndInit();
		...
		public DevExpress.XtraBars.Ribbon.RibbonControl rcJournalsList;
		...
		private DevExpress.XtraBars.Ribbon.RibbonPage rpJournalsList;
		...
		private DevExpress.XtraEditors.Repository.RepositoryItemSearchLookUpEdit repWorkingYear1;
