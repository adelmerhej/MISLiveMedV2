...
{
	partial class MigrateJournalsForm
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			gridLevelNode1.RelationName = "fk_JournalDetails";
			this.gcJournals.LevelTree.Nodes.AddRange(new DevExpress.XtraGrid.GridLevelNode[] {
            gridLevelNode1});
			this.gcJournals.Location = new System.Drawing.Point(24, 100);
			...
			this.gcJournals.Size = new System.Drawing.Size(1008, 402);
			this.gcJournals.TabIndex = 20;
			...
			this.gvJournals.OptionsBehavior.AllowAddRows = DevExpress.Utils.DefaultBoolean.False;
			this.gvJournals.OptionsBehavior.AllowDeleteRows = DevExpress.Utils.DefaultBoolean.False;
			...
			this.gvJournals.SortInfo.AddRange(new DevExpress.XtraGrid.Columns.GridColumnSortInfo[] {
            new DevExpress.XtraGrid.Columns.GridColumnSortInfo(this.colJournalTypeId, DevExpress.Data.ColumnSortOrder.Ascending)});
			...
			this.colJvNo.VisibleIndex = 1;
			this.colJvNo.Width = 80;
			// 
			// colJournalTypeId
			// 
			...
			this.colJournalTypeId.VisibleIndex = 2;
			this.colJournalTypeId.Width = 120;
			// 
			// colJournalDate
			// 
			...
			this.colJournalDate.VisibleIndex = 3;
			this.colJournalDate.Width = 151;
			// 
			// colReference
			// 
			...
			this.colIsPosted.VisibleIndex = 7;
			...
			// layoutControlItem2
			// 
			this.layoutControlItem2.Control = this.gcJournals;
