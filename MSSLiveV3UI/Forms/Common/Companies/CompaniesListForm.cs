...
namespace MISLiveMed.UI.Forms.Common.Companies
{
	public partial class CompaniesListForm : RibbonForm, IFormWithRibbon
	{
		...
		{
			LayoutsStyle.LoadLayoutGrid(gvCompanies, CurrentUser.UserName);
		}
		...
		private void btnResetGridStyle_ItemClick(object sender, ItemClickEventArgs e)
		{
			...
			{
				_resetMenu = true;
				LayoutsStyle.ResetLayoutGrid(gvCompanies, CurrentUser.UserName);
			}
		}
		...
		private void CompaniesListForm_FormClosing(object sender, FormClosingEventArgs e)
		{
			if (!_resetMenu)
			{
				LayoutsStyle.SaveLayoutGrid(gvCompanies, CurrentUser.UserName);
			}
		}
