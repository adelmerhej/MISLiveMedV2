...
namespace MISLiveMed.UI.Forms.Common.Countries
{
    public partial class ProvincesListForm : RibbonForm, IFormWithRibbon
    {
        ...
        {
	        LayoutsStyle.LoadLayoutGrid(gvProvinces, CurrentUser.UserName);
		}
		...
		private void btnResetGridStyle_ItemClick(object sender, ItemClickEventArgs e)
		{
			...
			{
				_resetMenu = true;
				LayoutsStyle.ResetLayoutGrid(gvProvinces, CurrentUser.UserName);
			}
		}
		...
		private void ProvincesListForm_FormClosing(object sender, FormClosingEventArgs e)
		{
			if (!_resetMenu)
			{
				LayoutsStyle.SaveLayoutGrid(gvProvinces, CurrentUser.UserName);
			}
		}
