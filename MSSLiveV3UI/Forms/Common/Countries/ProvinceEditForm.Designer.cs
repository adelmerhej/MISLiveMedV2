...
namespace MISLiveMed.UI.Forms.Common.Countries
{
    partial class ProvinceEditForm
    {
        ...
        private void InitializeComponent()
        {
			...
			// cboCountries
			// 
			this.cboCountries.Location = new System.Drawing.Point(80, 104);
			...
			this.cboCountries.Size = new System.Drawing.Size(494, 22);
			...
			this.colName.Width = 786;
			// 
			// chkActive
			// 
			this.chkActive.DataBindings.Add(new System.Windows.Forms.Binding("EditValue", this.bsProvince, "Active", true));
			this.chkActive.Enabled = false;
			this.chkActive.Location = new System.Drawing.Point(480, 50);
			...
			// bsProvince
			// 
			this.bsProvince.DataSource = typeof(ProvinceModel);
			// 
			// txtNotes
			// 
			this.txtNotes.DataBindings.Add(new System.Windows.Forms.Binding("EditValue", this.bsProvince, "Notes", true));
			...
			// txtId
			// 
			this.txtId.DataBindings.Add(new System.Windows.Forms.Binding("EditValue", this.bsProvince, "Id", true));
			...
			// txtName
			// 
			this.txtName.DataBindings.Add(new System.Windows.Forms.Binding("EditValue", this.bsProvince, "Name", true));
			...
			this.grpInfo.Size = new System.Drawing.Size(578, 130);
			this.grpInfo.Text = "Province Info";
			// 
			// lblMainRegionId
			// 
			...
			this.lblMainRegionId.Size = new System.Drawing.Size(200, 28);
			...
			this.Text = "Edit Province";
			this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.ProvinceEditForm_FormClosing);
        ...
        private System.Windows.Forms.BindingSource bsProvince;
