...
namespace MISLiveMed.UI.Forms.Common.Countries.Ports
{
    partial class AirportEditForm
    {
        ...
        private void InitializeComponent()
        {
			...
			// txtCode
			// 
			this.txtCode.DataBindings.Add(new System.Windows.Forms.Binding("EditValue", this.bsAirport, "Code", true));
			...
			// bsAirport
			// 
			this.bsAirport.DataSource = typeof(AirportModel);
			// 
			// cboCities
			// 
			...
			// colCityId
			// 
			this.colCityId.Caption = "Id";
			this.colCityId.FieldName = "Id";
			this.colCityId.Name = "colCityId";
			this.colCityId.Visible = true;
			this.colCityId.VisibleIndex = 0;
			this.colCityId.Width = 71;
			// 
			// colCityCode
			// 
			this.colCityCode.Caption = "Code";
			...
			this.colCityCode.Width = 109;
			// 
			// colCityName
			// 
			this.colCityName.Caption = "Name";
			...
			// colCountryCode
			// 
			this.colCountryCode.Caption = "Code";
			...
			// chkActive
			// 
			this.chkActive.DataBindings.Add(new System.Windows.Forms.Binding("EditValue", this.bsAirport, "Active", true));
			...
			// txtNotes
			// 
			this.txtNotes.DataBindings.Add(new System.Windows.Forms.Binding("EditValue", this.bsAirport, "Notes", true));
			...
			// txtId
			// 
			this.txtId.DataBindings.Add(new System.Windows.Forms.Binding("EditValue", this.bsAirport, "Id", true));
			...
			// txtName
			// 
			this.txtName.DataBindings.Add(new System.Windows.Forms.Binding("EditValue", this.bsAirport, "Name", true));
			...
			this.grpInfo.Text = "Airport Info";
			// 
			// lblMainRegionId
			// 
			...
			this.Text = "Edit Airport";
			this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.AirportEditForm_FormClosing);
