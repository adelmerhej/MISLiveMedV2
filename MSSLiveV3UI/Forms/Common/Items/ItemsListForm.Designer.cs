namespace MISLiveMed.UI.Forms.Common.Items
{
    partial class ItemsListForm
    {
        ...
        private void InitializeComponent()
        {
			...
			this.gcItemsList = new DevExpress.XtraGrid.GridControl();
			this.gvItemsList = new DevExpress.XtraGrid.Views.Grid.GridView();
			...
			((System.ComponentModel.ISupportInitialize)(this.gcItemsList)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.gvItemsList)).BeginInit();
            ...
            this.rpItemsList,
            this.rpViewSettings});
			this.rcItemsList.Size = new System.Drawing.Size(1380, 193);
			...
			// mainLayout
			// 
			this.mainLayout.Controls.Add(this.gcItemsList);
			this.mainLayout.Dock = System.Windows.Forms.DockStyle.Fill;
			this.mainLayout.Location = new System.Drawing.Point(0, 193);
			this.mainLayout.Name = "mainLayout";
			this.mainLayout.Root = this.Root;
			this.mainLayout.Size = new System.Drawing.Size(1380, 511);
			...
			this.Root.Name = "Root";
			this.Root.Size = new System.Drawing.Size(1380, 511);
			this.Root.TextVisible = false;
			// 
			// gcItemsList
			// 
			this.gcItemsList.EmbeddedNavigator.Buttons.Append.Visible = false;
			this.gcItemsList.EmbeddedNavigator.Buttons.CancelEdit.Visible = false;
			this.gcItemsList.EmbeddedNavigator.Buttons.Edit.Visible = false;
			this.gcItemsList.EmbeddedNavigator.Buttons.EndEdit.Visible = false;
			this.gcItemsList.EmbeddedNavigator.Buttons.Remove.Visible = false;
			this.gcItemsList.EmbeddedNavigator.Margin = new System.Windows.Forms.Padding(3, 5, 3, 5);
			this.gcItemsList.Location = new System.Drawing.Point(12, 12);
			this.gcItemsList.MainView = this.gvItemsList;
			this.gcItemsList.Margin = new System.Windows.Forms.Padding(3, 4, 3, 4);
			this.gcItemsList.Name = "gcItemsList";
			this.gcItemsList.RepositoryItems.AddRange(new DevExpress.XtraEditors.Repository.RepositoryItem[] {
            ...
            this.chkActive,
            this.chkJobActive});
			this.gcItemsList.Size = new System.Drawing.Size(1356, 487);
			this.gcItemsList.TabIndex = 6;
			this.gcItemsList.UseEmbeddedNavigator = true;
			this.gcItemsList.ViewCollection.AddRange(new DevExpress.XtraGrid.Views.Base.BaseView[] {
            this.gvItemsList});
			// 
			// gvItemsList
			// 
			this.gvItemsList.DetailHeight = 458;
			this.gvItemsList.GridControl = this.gcItemsList;
			this.gvItemsList.GroupSummary.AddRange(new DevExpress.XtraGrid.GridSummaryItem[] {
            new DevExpress.XtraGrid.GridGroupSummaryItem(DevExpress.Data.SummaryItemType.Count, "Name", null, "")});
			this.gvItemsList.Name = "gvItemsList";
			this.gvItemsList.OptionsBehavior.AllowFixedGroups = DevExpress.Utils.DefaultBoolean.True;
			this.gvItemsList.OptionsBehavior.AutoExpandAllGroups = true;
			this.gvItemsList.OptionsBehavior.Editable = false;
			this.gvItemsList.OptionsDetail.EnableMasterViewMode = false;
			this.gvItemsList.OptionsFind.AlwaysVisible = true;
			this.gvItemsList.OptionsPrint.AutoWidth = false;
			this.gvItemsList.OptionsPrint.PrintHorzLines = false;
			this.gvItemsList.OptionsPrint.PrintVertLines = false;
			this.gvItemsList.OptionsView.ColumnAutoWidth = false;
			this.gvItemsList.OptionsView.ShowFooter = true;
			this.gvItemsList.OptionsView.ShowGroupedColumns = true;
			this.gvItemsList.OptionsView.ShowGroupPanel = false;
			this.gvItemsList.OptionsView.ShowIndicator = false;
			this.gvItemsList.OptionsView.ShowVerticalLines = DevExpress.Utils.DefaultBoolean.False;
			// 
			...
			// layoutControlItem1
			// 
			this.layoutControlItem1.Control = this.gcItemsList;
			this.layoutControlItem1.Location = new System.Drawing.Point(0, 0);
			this.layoutControlItem1.Name = "layoutControlItem1";
			this.layoutControlItem1.Size = new System.Drawing.Size(1360, 491);
			...
			this.ClientSize = new System.Drawing.Size(1380, 734);
			...
			this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.ItemsListForm_FormClosing);
			((System.ComponentModel.ISupportInitialize)(this.rcItemsList)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.mainLayout)).EndInit();
			this.mainLayout.ResumeLayout(false);
			((System.ComponentModel.ISupportInitialize)(this.Root)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.bsItems)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.gcItemsList)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.gvItemsList)).EndInit();
		...
		private DevExpress.XtraGrid.GridControl gcItemsList;
		private DevExpress.XtraGrid.Views.Grid.GridView gvItemsList;
