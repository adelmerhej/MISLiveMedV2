namespace MISLiveMed.UI.Forms.Common.Carriers
{
    partial class VesselsListForm
    {
        ...
        {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(VesselsListForm));
			this.rcVessels = new DevExpress.XtraBars.Ribbon.RibbonControl();
			...
			this.rpVessels = new DevExpress.XtraBars.Ribbon.RibbonPage();
			...
			this.gcVessels = new DevExpress.XtraGrid.GridControl();
			this.gvVessels = new DevExpress.XtraGrid.Views.Grid.GridView();
			this.colId = new DevExpress.XtraGrid.Columns.GridColumn();
			this.colCarrierName = new DevExpress.XtraGrid.Columns.GridColumn();
			this.colArabicName = new DevExpress.XtraGrid.Columns.GridColumn();
			this.colCaptainName = new DevExpress.XtraGrid.Columns.GridColumn();
			this.colNationalityId = new DevExpress.XtraGrid.Columns.GridColumn();
			this.repCountryList = new DevExpress.XtraEditors.Repository.RepositoryItemLookUpEdit();
			this.colFlag = new DevExpress.XtraGrid.Columns.GridColumn();
			this.colAgentId = new DevExpress.XtraGrid.Columns.GridColumn();
			this.repAgentsList = new DevExpress.XtraEditors.Repository.RepositoryItemLookUpEdit();
			this.colSeaLineId = new DevExpress.XtraGrid.Columns.GridColumn();
			this.repSeaLinesList = new DevExpress.XtraEditors.Repository.RepositoryItemLookUpEdit();
			this.colShipmentNatureId = new DevExpress.XtraGrid.Columns.GridColumn();
			this.repShipmentNatureList = new DevExpress.XtraEditors.Repository.RepositoryItemLookUpEdit();
			this.colIMONumber = new DevExpress.XtraGrid.Columns.GridColumn();
			...
			((System.ComponentModel.ISupportInitialize)(this.rcVessels)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.mainLayout)).BeginInit();
			this.mainLayout.SuspendLayout();
			((System.ComponentModel.ISupportInitialize)(this.gcVessels)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.gvVessels)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.repCountryList)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.repAgentsList)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.repSeaLinesList)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.repShipmentNatureList)).BeginInit();
			...
			// rcVessels
			// 
			this.rcVessels.EmptyAreaImageOptions.ImagePadding = new System.Windows.Forms.Padding(35, 39, 35, 39);
			this.rcVessels.ExpandCollapseItem.Id = 0;
			this.rcVessels.Items.AddRange(new DevExpress.XtraBars.BarItem[] {
            this.rcVessels.ExpandCollapseItem,
            this.btnNew,
            this.btnDelete,
            this.btnEdit,
            this.btnPrint,
			...
			this.rcVessels.Location = new System.Drawing.Point(0, 0);
			this.rcVessels.Margin = new System.Windows.Forms.Padding(3, 4, 3, 4);
			this.rcVessels.MaxItemId = 42;
			this.rcVessels.MdiMergeStyle = DevExpress.XtraBars.Ribbon.RibbonMdiMergeStyle.Always;
			this.rcVessels.Name = "rcVessels";
			this.rcVessels.OptionsMenuMinWidth = 385;
			this.rcVessels.Pages.AddRange(new DevExpress.XtraBars.Ribbon.RibbonPage[] {
            this.rpVessels,
            this.rpViewSettings});
			this.rcVessels.Size = new System.Drawing.Size(1455, 193);
			this.rcVessels.StatusBar = this.ribbonStatusBar1;
			// 
			// btnNew
			// 
			...
			// rpVessels
			// 
			this.rpVessels.Groups.AddRange(new DevExpress.XtraBars.Ribbon.RibbonPageGroup[] {
            this.ribbonPageGroup1,
            this.ribbonPageGroup6,
            this.ribbonPageGroup8,
            this.ribbonPageGroup11});
			this.rpVessels.Name = "rpVessels";
			this.rpVessels.Text = "Vessels Menu";
			// 
			// ribbonPageGroup1
			// 
			...
			this.ribbonStatusBar1.Ribbon = this.rcVessels;
			this.ribbonStatusBar1.Size = new System.Drawing.Size(1455, 30);
			// 
			// mainLayout
			// 
			this.mainLayout.Controls.Add(this.gcVessels);
			this.mainLayout.Dock = System.Windows.Forms.DockStyle.Fill;
			this.mainLayout.Location = new System.Drawing.Point(0, 193);
			this.mainLayout.Name = "mainLayout";
			this.mainLayout.Root = this.Root;
			this.mainLayout.Size = new System.Drawing.Size(1455, 556);
			this.mainLayout.TabIndex = 15;
			this.mainLayout.Text = "layoutControl1";
			// 
			// gcVessels
			// 
			this.gcVessels.EmbeddedNavigator.Buttons.Append.Visible = false;
			this.gcVessels.EmbeddedNavigator.Buttons.CancelEdit.Visible = false;
			this.gcVessels.EmbeddedNavigator.Buttons.Edit.Visible = false;
			...
			this.gcVessels.RepositoryItems.AddRange(new DevExpress.XtraEditors.Repository.RepositoryItem[] {
			...
			// gvVessels
			// 
			this.gvVessels.Columns.AddRange(new DevExpress.XtraGrid.Columns.GridColumn[] {
            this.colId,
            this.colCarrierName,
            this.colArabicName,
            this.colCaptainName,
            ...
            this.colAgentId,
            this.colSeaLineId,
            this.colShipmentNatureId,
            this.colIMONumber,
            this.colNotes,
            this.colActive});
			this.gvVessels.DetailHeight = 458;
			this.gvVessels.GridControl = this.gcVessels;
			this.gvVessels.GroupSummary.AddRange(new DevExpress.XtraGrid.GridSummaryItem[] {
            new DevExpress.XtraGrid.GridGroupSummaryItem(DevExpress.Data.SummaryItemType.Count, "Name", null, "")});
			this.gvVessels.Name = "gvVessels";
			this.gvVessels.OptionsBehavior.AllowFixedGroups = DevExpress.Utils.DefaultBoolean.True;
			this.gvVessels.OptionsBehavior.AllowPixelScrolling = DevExpress.Utils.DefaultBoolean.True;
			this.gvVessels.OptionsBehavior.AutoExpandAllGroups = true;
			this.gvVessels.OptionsBehavior.Editable = false;
			this.gvVessels.OptionsDetail.EnableMasterViewMode = false;
			this.gvVessels.OptionsFind.AlwaysVisible = true;
			this.gvVessels.OptionsPrint.AutoWidth = false;
			this.gvVessels.OptionsPrint.PrintHorzLines = false;
			this.gvVessels.OptionsPrint.PrintVertLines = false;
			this.gvVessels.OptionsView.ColumnAutoWidth = false;
			this.gvVessels.OptionsView.ShowFooter = true;
			this.gvVessels.OptionsView.ShowGroupedColumns = true;
			...
			// colCarrierName
			// 
			this.colCarrierName.Caption = "Carrier Name";
			this.colCarrierName.FieldName = "CarrierName";
			this.colCarrierName.MinWidth = 25;
			this.colCarrierName.Name = "colCarrierName";
			this.colCarrierName.Visible = true;
			this.colCarrierName.VisibleIndex = 1;
			this.colCarrierName.Width = 280;
			// 
			// colArabicName
			// 
			this.colArabicName.Caption = "Arabic Name";
			this.colArabicName.FieldName = "ArabicName";
			this.colArabicName.MinWidth = 25;
			this.colArabicName.Name = "colArabicName";
			this.colArabicName.Visible = true;
			this.colArabicName.VisibleIndex = 2;
			this.colArabicName.Width = 249;
			// 
			// colCaptainName
			// 
			this.colCaptainName.Caption = "Captain Name";
			this.colCaptainName.FieldName = "CaptainName";
			this.colCaptainName.MinWidth = 25;
			this.colCaptainName.Name = "colCaptainName";
			this.colCaptainName.Visible = true;
			this.colCaptainName.VisibleIndex = 3;
			this.colCaptainName.Width = 220;
			// 
			// colNationalityId
			// 
			this.colNationalityId.Caption = "Nationality";
			this.colNationalityId.ColumnEdit = this.repCountryList;
			this.colNationalityId.FieldName = "NationalityId";
			this.colNationalityId.MinWidth = 25;
			this.colNationalityId.Name = "colNationalityId";
			this.colNationalityId.Visible = true;
			this.colNationalityId.VisibleIndex = 4;
			this.colNationalityId.Width = 160;
			// 
			// repCountryList
			// 
			this.repCountryList.AutoHeight = false;
			this.repCountryList.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {
            new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
			this.repCountryList.Columns.AddRange(new DevExpress.XtraEditors.Controls.LookUpColumnInfo[] {
			...
			this.repCountryList.DisplayMember = "CountryName";
			this.repCountryList.Name = "repCountryList";
			this.repCountryList.NullText = "";
			this.repCountryList.ValueMember = "Id";
			// 
			// colFlag
			// 
			this.colFlag.Caption = "Flag";
			this.colFlag.FieldName = "Flag";
			this.colFlag.MinWidth = 25;
			this.colFlag.Name = "colFlag";
			this.colFlag.Visible = true;
			this.colFlag.VisibleIndex = 6;
			this.colFlag.Width = 91;
			// 
			// colAgentId
			// 
			this.colAgentId.Caption = "Agent";
			this.colAgentId.ColumnEdit = this.repAgentsList;
			this.colAgentId.FieldName = "AgentId";
			this.colAgentId.MinWidth = 25;
			this.colAgentId.Name = "colAgentId";
			this.colAgentId.Visible = true;
			this.colAgentId.VisibleIndex = 7;
			this.colAgentId.Width = 95;
			// 
			// repAgentsList
			// 
			this.repAgentsList.AutoHeight = false;
			this.repAgentsList.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {
            new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
			this.repAgentsList.Columns.AddRange(new DevExpress.XtraEditors.Controls.LookUpColumnInfo[] {
            new DevExpress.XtraEditors.Controls.LookUpColumnInfo("Id", "Id", 20, DevExpress.Utils.FormatType.None, "", false, DevExpress.Utils.HorzAlignment.Default, DevExpress.Data.ColumnSortOrder.None, DevExpress.Utils.DefaultBoolean.Default),
			...
			this.repAgentsList.DisplayMember = "MemberName";
			this.repAgentsList.Name = "repAgentsList";
			this.repAgentsList.NullText = "";
			this.repAgentsList.ValueMember = "Id";
			// 
			// colSeaLineId
			// 
			this.colSeaLineId.Caption = "SeaLine";
			this.colSeaLineId.ColumnEdit = this.repSeaLinesList;
			this.colSeaLineId.FieldName = "SeaLineId";
			this.colSeaLineId.MinWidth = 25;
			this.colSeaLineId.Name = "colSeaLineId";
			this.colSeaLineId.Visible = true;
			this.colSeaLineId.VisibleIndex = 5;
			this.colSeaLineId.Width = 240;
			// 
			// repSeaLinesList
			// 
			this.repSeaLinesList.AutoHeight = false;
			this.repSeaLinesList.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {
            new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
			this.repSeaLinesList.Name = "repSeaLinesList";
			this.repSeaLinesList.NullText = "";
			// 
			// colShipmentNatureId
			// 
			this.colShipmentNatureId.Caption = "Shipment Nature";
			this.colShipmentNatureId.ColumnEdit = this.repShipmentNatureList;
			this.colShipmentNatureId.FieldName = "ShipmentNatureId";
			this.colShipmentNatureId.MinWidth = 25;
			this.colShipmentNatureId.Name = "colShipmentNatureId";
			this.colShipmentNatureId.Visible = true;
			this.colShipmentNatureId.VisibleIndex = 8;
			this.colShipmentNatureId.Width = 181;
			// 
			// repShipmentNatureList
			// 
			this.repShipmentNatureList.AutoHeight = false;
			this.repShipmentNatureList.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {
            new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
			this.repShipmentNatureList.Name = "repShipmentNatureList";
			this.repShipmentNatureList.NullText = "";
			// 
			// colIMONumber
			// 
			this.colIMONumber.Caption = "IMO Number";
			this.colIMONumber.FieldName = "IMONumber";
			this.colIMONumber.MinWidth = 25;
			this.colIMONumber.Name = "colIMONumber";
			this.colIMONumber.Visible = true;
			this.colIMONumber.VisibleIndex = 9;
			this.colIMONumber.Width = 106;
			// 
			// colNotes
			// 
			...
			this.Root.Name = "Root";
			this.Root.Size = new System.Drawing.Size(1455, 556);
			...
			this.Text = "Vessels List";
			this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.VesselsListForm_FormClosing);
			((System.ComponentModel.ISupportInitialize)(this.rcVessels)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.mainLayout)).EndInit();
			this.mainLayout.ResumeLayout(false);
			((System.ComponentModel.ISupportInitialize)(this.gcVessels)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.gvVessels)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.repCountryList)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.repAgentsList)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.repSeaLinesList)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.repShipmentNatureList)).EndInit();
        ...
        public DevExpress.XtraBars.Ribbon.RibbonControl rcVessels;
        ...
        private DevExpress.XtraBars.Ribbon.RibbonPage rpVessels;
        ...
        private DevExpress.XtraGrid.GridControl gcVessels;
        private DevExpress.XtraGrid.Views.Grid.GridView gvVessels;
        private DevExpress.XtraGrid.Columns.GridColumn colId;
        private DevExpress.XtraGrid.Columns.GridColumn colCarrierName;
        private DevExpress.XtraGrid.Columns.GridColumn colArabicName;
        private DevExpress.XtraGrid.Columns.GridColumn colCaptainName;
        private DevExpress.XtraGrid.Columns.GridColumn colNationalityId;
        private DevExpress.XtraEditors.Repository.RepositoryItemLookUpEdit repCountryList;
        private DevExpress.XtraGrid.Columns.GridColumn colFlag;
        private DevExpress.XtraGrid.Columns.GridColumn colAgentId;
        private DevExpress.XtraEditors.Repository.RepositoryItemLookUpEdit repAgentsList;
        private DevExpress.XtraGrid.Columns.GridColumn colSeaLineId;
        private DevExpress.XtraEditors.Repository.RepositoryItemLookUpEdit repSeaLinesList;
        private DevExpress.XtraGrid.Columns.GridColumn colShipmentNatureId;
        private DevExpress.XtraEditors.Repository.RepositoryItemLookUpEdit repShipmentNatureList;
        private DevExpress.XtraGrid.Columns.GridColumn colIMONumber;
