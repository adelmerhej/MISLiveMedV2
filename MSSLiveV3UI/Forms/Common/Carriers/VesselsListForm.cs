...
namespace MISLiveMed.UI.Forms.Common.Carriers
{
	public partial class VesselsListForm : RibbonForm, IFormWithRibbon
	{
		...
		{
			VesselEditForm frm = new VesselEditForm(new VesselModel(), false);
			frm.ShowDialog();
		}
		...
		private void gvVessels_DoubleClick(object sender, EventArgs e)
		{
			if (!_isAdmin && !_canEdit) return;
		}

		private void gvVessels_RowCellStyle(object sender, RowCellStyleEventArgs e)
		{
