...
namespace MISLiveMed.UI.Forms.Common.Carriers
{
    partial class VesselEditForm
    {
        ...
        private void InitializeComponent()
        {
			...
			this.cboNationalities = new DevExpress.XtraEditors.SearchLookUpEdit();
			this.searchLookUpEdit1View = new DevExpress.XtraGrid.Views.Grid.GridView();
			this.colId = new DevExpress.XtraGrid.Columns.GridColumn();
			this.gridColumn2 = new DevExpress.XtraGrid.Columns.GridColumn();
			this.txtFlag = new DevExpress.XtraEditors.TextEdit();
			this.txtCaptainName = new DevExpress.XtraEditors.TextEdit();
			this.txtArabicName = new DevExpress.XtraEditors.TextEdit();
			...
			this.lblArabicName = new DevExpress.XtraLayout.LayoutControlItem();
			this.lblCaptainName = new DevExpress.XtraLayout.LayoutControlItem();
			this.lblFlag = new DevExpress.XtraLayout.LayoutControlItem();
			this.emptySpaceItem4 = new DevExpress.XtraLayout.EmptySpaceItem();
			this.lblNationalities = new DevExpress.XtraLayout.LayoutControlItem();
			this.lblShipLineAgents = new DevExpress.XtraLayout.LayoutControlItem();
			this.lblIMONumber = new DevExpress.XtraLayout.LayoutControlItem();
			...
			((System.ComponentModel.ISupportInitialize)(this.txtCaptainName.Properties)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.txtArabicName.Properties)).BeginInit();
			...
			((System.ComponentModel.ISupportInitialize)(this.lblArabicName)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.lblCaptainName)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.lblFlag)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.emptySpaceItem4)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.lblNationalities)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.lblShipLineAgents)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.lblIMONumber)).BeginInit();
			...
			this.mainLayout.Controls.Add(this.chkFeederVessel);
			this.mainLayout.Controls.Add(this.txtIMONumber);
			this.mainLayout.Controls.Add(this.cboShipLineAgents);
			this.mainLayout.Controls.Add(this.cboNationalities);
			this.mainLayout.Controls.Add(this.txtFlag);
			this.mainLayout.Controls.Add(this.txtCaptainName);
			this.mainLayout.Controls.Add(this.txtArabicName);
			...
			this.cboShipLineAgents.Properties.DisplayMember = "AgentName";
			this.cboShipLineAgents.Properties.NullText = "";
			...
			// gridColumn3
			// 
			this.gridColumn3.Caption = "Agent Name";
			this.gridColumn3.FieldName = "AgentName";
			this.gridColumn3.Name = "gridColumn3";
			this.gridColumn3.Visible = true;
			this.gridColumn3.VisibleIndex = 1;
			this.gridColumn3.Width = 1110;
			// 
			// cboNationalities
			// 
            ...
            new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
			this.cboNationalities.Properties.DisplayMember = "CountryName";
			this.cboNationalities.Properties.NullText = "";
			...
			this.layoutControlGroup1.Size = new System.Drawing.Size(797, 471);
            ...
            this.lblNationalities,
            this.lblShipLineAgents,
            this.lblIMONumber,
			...
			((System.ComponentModel.ISupportInitialize)(this.txtCaptainName.Properties)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.txtArabicName.Properties)).EndInit();
			...
			((System.ComponentModel.ISupportInitialize)(this.lblArabicName)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.lblCaptainName)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.lblFlag)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.emptySpaceItem4)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.lblNationalities)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.lblShipLineAgents)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.lblIMONumber)).EndInit();
