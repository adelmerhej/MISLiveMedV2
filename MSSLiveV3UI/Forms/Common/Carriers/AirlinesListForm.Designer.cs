...
{
    partial class AirlinesListForm
    {
        /// <summary>
        ...
        {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(AirlinesListForm));
			this.rcAirlinesList = new DevExpress.XtraBars.Ribbon.RibbonControl();
			...
			this.rpAirlinesList = new DevExpress.XtraBars.Ribbon.RibbonPage();
			...
			this.gcAirlines = new DevExpress.XtraGrid.GridControl();
			this.gvAirlines = new DevExpress.XtraGrid.Views.Grid.GridView();
			this.colAirlinesId = new DevExpress.XtraGrid.Columns.GridColumn();
			this.colAirlineName = new DevExpress.XtraGrid.Columns.GridColumn();
			this.colIntegerCode = new DevExpress.XtraGrid.Columns.GridColumn();
			this.colAbrevCode = new DevExpress.XtraGrid.Columns.GridColumn();
			this.colFlightCode = new DevExpress.XtraGrid.Columns.GridColumn();
			this.colAirlineNameAWB = new DevExpress.XtraGrid.Columns.GridColumn();
			this.colNationality = new DevExpress.XtraGrid.Columns.GridColumn();
			this.repNationalitiesList = new DevExpress.XtraEditors.Repository.RepositoryItemLookUpEdit();
			this.colGSAAgent = new DevExpress.XtraGrid.Columns.GridColumn();
			this.colReportId = new DevExpress.XtraGrid.Columns.GridColumn();
			this.colAirlineDate = new DevExpress.XtraGrid.Columns.GridColumn();
			this.repositoryItemDateEdit2 = new DevExpress.XtraEditors.Repository.RepositoryItemDateEdit();
			this.colIataCode = new DevExpress.XtraGrid.Columns.GridColumn();
			this.colAwbPrefix = new DevExpress.XtraGrid.Columns.GridColumn();
			...
			this.repMembersListView = new DevExpress.XtraGrid.Views.Grid.GridView();
			...
			((System.ComponentModel.ISupportInitialize)(this.rcAirlinesList)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.mainLayout)).BeginInit();
			this.mainLayout.SuspendLayout();
			((System.ComponentModel.ISupportInitialize)(this.gcAirlines)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.gvAirlines)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.repNationalitiesList)).BeginInit();
			...
			((System.ComponentModel.ISupportInitialize)(this.repMembersListView)).BeginInit();
			...
			// rcAirlinesList
			// 
			this.rcAirlinesList.EmptyAreaImageOptions.ImagePadding = new System.Windows.Forms.Padding(35, 39, 35, 39);
			this.rcAirlinesList.ExpandCollapseItem.Id = 0;
			this.rcAirlinesList.Items.AddRange(new DevExpress.XtraBars.BarItem[] {
            this.rcAirlinesList.ExpandCollapseItem,
            this.btnNew,
            this.btnDelete,
            this.btnEdit,
            this.btnPrint,
			...
			this.rcAirlinesList.Location = new System.Drawing.Point(0, 0);
			this.rcAirlinesList.Margin = new System.Windows.Forms.Padding(3, 4, 3, 4);
			this.rcAirlinesList.MaxItemId = 41;
			this.rcAirlinesList.MdiMergeStyle = DevExpress.XtraBars.Ribbon.RibbonMdiMergeStyle.Always;
			this.rcAirlinesList.Name = "rcAirlinesList";
			this.rcAirlinesList.OptionsMenuMinWidth = 385;
			this.rcAirlinesList.Pages.AddRange(new DevExpress.XtraBars.Ribbon.RibbonPage[] {
            this.rpAirlinesList,
            this.rpViewSettings});
			this.rcAirlinesList.Size = new System.Drawing.Size(1401, 193);
			this.rcAirlinesList.StatusBar = this.ribbonStatusBar1;
			// 
			// btnNew
			// 
			...
			// rpAirlinesList
			// 
			this.rpAirlinesList.Groups.AddRange(new DevExpress.XtraBars.Ribbon.RibbonPageGroup[] {
            this.ribbonPageGroup1,
            this.ribbonPageGroup6,
            this.ribbonPageGroup8,
            this.ribbonPageGroup11});
			this.rpAirlinesList.Name = "rpAirlinesList";
			this.rpAirlinesList.Text = "AIRLINES LIST";
			// 
			// ribbonPageGroup1
			// 
			...
			this.ribbonStatusBar1.Ribbon = this.rcAirlinesList;
			this.ribbonStatusBar1.Size = new System.Drawing.Size(1401, 30);
			// 
			// mainLayout
			// 
			this.mainLayout.Controls.Add(this.gcAirlines);
			this.mainLayout.Dock = System.Windows.Forms.DockStyle.Fill;
			this.mainLayout.Location = new System.Drawing.Point(0, 193);
			this.mainLayout.Name = "mainLayout";
			this.mainLayout.Root = this.Root;
			this.mainLayout.Size = new System.Drawing.Size(1401, 518);
			this.mainLayout.TabIndex = 5;
			this.mainLayout.Text = "layoutControl1";
			// 
			// gcAirlines
			// 
			this.gcAirlines.EmbeddedNavigator.Buttons.Append.Visible = false;
			this.gcAirlines.EmbeddedNavigator.Buttons.CancelEdit.Visible = false;
			this.gcAirlines.EmbeddedNavigator.Buttons.Edit.Visible = false;
			...
			this.gcAirlines.RepositoryItems.AddRange(new DevExpress.XtraEditors.Repository.RepositoryItem[] {
			...
			// gvAirlines
			// 
			this.gvAirlines.Columns.AddRange(new DevExpress.XtraGrid.Columns.GridColumn[] {
            this.colAirlinesId,
            this.colAirlineName,
            this.colIntegerCode,
            this.colAbrevCode,
            this.colFlightCode,
            this.colAirlineNameAWB,
            this.colNationality,
            this.colGSAAgent,
            this.colReportId,
            this.colAirlineDate,
            ...
            this.colActive,
            this.colNotes});
			this.gvAirlines.DetailHeight = 458;
			this.gvAirlines.GridControl = this.gcAirlines;
			this.gvAirlines.GroupSummary.AddRange(new DevExpress.XtraGrid.GridSummaryItem[] {
            new DevExpress.XtraGrid.GridGroupSummaryItem(DevExpress.Data.SummaryItemType.Count, "Name", null, "")});
			this.gvAirlines.Name = "gvAirlines";
			this.gvAirlines.OptionsBehavior.AllowFixedGroups = DevExpress.Utils.DefaultBoolean.True;
			this.gvAirlines.OptionsBehavior.AutoExpandAllGroups = true;
			this.gvAirlines.OptionsBehavior.Editable = false;
			this.gvAirlines.OptionsDetail.EnableMasterViewMode = false;
			this.gvAirlines.OptionsFind.AlwaysVisible = true;
			this.gvAirlines.OptionsPrint.AutoWidth = false;
			this.gvAirlines.OptionsPrint.PrintHorzLines = false;
			this.gvAirlines.OptionsPrint.PrintVertLines = false;
			this.gvAirlines.OptionsView.ColumnAutoWidth = false;
			this.gvAirlines.OptionsView.ShowFooter = true;
			this.gvAirlines.OptionsView.ShowGroupedColumns = true;
			...
			// colAirlinesId
			// 
			this.colAirlinesId.Caption = "Id";
			this.colAirlinesId.FieldName = "Id";
			this.colAirlinesId.MinWidth = 25;
			this.colAirlinesId.Name = "colAirlinesId";
			this.colAirlinesId.Visible = true;
			this.colAirlinesId.VisibleIndex = 0;
			this.colAirlinesId.Width = 55;
			// 
			// colAirlineName
			// 
			this.colAirlineName.Caption = "Airline Name";
			this.colAirlineName.FieldName = "AirlineName";
			this.colAirlineName.MinWidth = 25;
			this.colAirlineName.Name = "colAirlineName";
			this.colAirlineName.Visible = true;
			this.colAirlineName.VisibleIndex = 1;
			this.colAirlineName.Width = 171;
			// 
			// colIntegerCode
			// 
			this.colIntegerCode.Caption = "Integer Code";
			this.colIntegerCode.FieldName = "IntegerCode";
			this.colIntegerCode.MinWidth = 25;
			this.colIntegerCode.Name = "colIntegerCode";
			this.colIntegerCode.Visible = true;
			this.colIntegerCode.VisibleIndex = 2;
			this.colIntegerCode.Width = 102;
			// 
			// colAbrevCode
			// 
			this.colAbrevCode.Caption = "Abreviation Code";
			this.colAbrevCode.FieldName = "AbrevCode";
			this.colAbrevCode.MinWidth = 25;
			this.colAbrevCode.Name = "colAbrevCode";
			this.colAbrevCode.Visible = true;
			this.colAbrevCode.VisibleIndex = 3;
			this.colAbrevCode.Width = 109;
			// 
			// colFlightCode
			// 
			this.colFlightCode.Caption = "Flight Code";
			this.colFlightCode.FieldName = "FlightCode";
			this.colFlightCode.MinWidth = 25;
			this.colFlightCode.Name = "colFlightCode";
			this.colFlightCode.Visible = true;
			this.colFlightCode.VisibleIndex = 4;
			this.colFlightCode.Width = 94;
			// 
			// colAirlineNameAWB
			// 
			this.colAirlineNameAWB.Caption = "Airline Name / AWB";
			this.colAirlineNameAWB.FieldName = "AirlineNameAWB";
			this.colAirlineNameAWB.MinWidth = 25;
			this.colAirlineNameAWB.Name = "colAirlineNameAWB";
			this.colAirlineNameAWB.Visible = true;
			this.colAirlineNameAWB.VisibleIndex = 5;
			this.colAirlineNameAWB.Width = 151;
			// 
			// colNationality
			// 
			this.colNationality.Caption = "Nationality";
			this.colNationality.ColumnEdit = this.repNationalitiesList;
			...
			this.colNationality.Width = 121;
			// 
			// repNationalitiesList
			// 
			this.repNationalitiesList.AutoHeight = false;
			this.repNationalitiesList.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {
            new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
			this.repNationalitiesList.Name = "repNationalitiesList";
			this.repNationalitiesList.NullText = "";
			// 
			// colGSAAgent
			// 
			this.colGSAAgent.Caption = "GSA Agent";
			this.colGSAAgent.FieldName = "GSAAgent";
			this.colGSAAgent.MinWidth = 25;
			this.colGSAAgent.Name = "colGSAAgent";
			this.colGSAAgent.Visible = true;
			this.colGSAAgent.VisibleIndex = 7;
			this.colGSAAgent.Width = 224;
			// 
			// colReportId
			// 
			this.colReportId.Caption = "Report ID";
			this.colReportId.FieldName = "ReportId";
			this.colReportId.MinWidth = 25;
			this.colReportId.Name = "colReportId";
			this.colReportId.Visible = true;
			this.colReportId.VisibleIndex = 8;
			this.colReportId.Width = 94;
			// 
			// colAirlineDate
			// 
			this.colAirlineDate.Caption = "Airline Date";
			this.colAirlineDate.ColumnEdit = this.repositoryItemDateEdit2;
			this.colAirlineDate.FieldName = "AirlineDate";
			this.colAirlineDate.MinWidth = 25;
			this.colAirlineDate.Name = "colAirlineDate";
			this.colAirlineDate.Visible = true;
			this.colAirlineDate.VisibleIndex = 9;
			this.colAirlineDate.Width = 94;
			// 
			...
			// colIataCode
			// 
			this.colIataCode.Caption = "Iata Code";
			this.colIataCode.FieldName = "IataCode";
			this.colIataCode.MinWidth = 25;
			this.colIataCode.Name = "colIataCode";
			this.colIataCode.Visible = true;
			this.colIataCode.VisibleIndex = 10;
			this.colIataCode.Width = 94;
			// 
			// colAwbPrefix
			// 
			this.colAwbPrefix.Caption = "Awb Prefix";
			this.colAwbPrefix.FieldName = "AwbPrefix";
			this.colAwbPrefix.MinWidth = 25;
			this.colAwbPrefix.Name = "colAwbPrefix";
			this.colAwbPrefix.Visible = true;
			this.colAwbPrefix.VisibleIndex = 11;
			this.colAwbPrefix.Width = 94;
			// 
			// colActive
			// 
			...
			this.repMembersList.PopupView = this.repMembersListView;
			this.repMembersList.ValueMember = "Id";
			// 
			// repMembersListView
			// 
			this.repMembersListView.FocusRectStyle = DevExpress.XtraGrid.Views.Grid.DrawFocusRectStyle.RowFocus;
			this.repMembersListView.Name = "repMembersListView";
			this.repMembersListView.OptionsSelection.EnableAppearanceFocusedCell = false;
			this.repMembersListView.OptionsView.ShowGroupPanel = false;
			// 
			// repPOLPortCodeList
			// 
			...
			this.Root.Name = "Root";
			this.Root.Size = new System.Drawing.Size(1401, 518);
			...
			this.Text = "AirLinesList";
			this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.AirlinesListForm_FormClosing);
			((System.ComponentModel.ISupportInitialize)(this.rcAirlinesList)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.mainLayout)).EndInit();
			this.mainLayout.ResumeLayout(false);
			((System.ComponentModel.ISupportInitialize)(this.gcAirlines)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.gvAirlines)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.repNationalitiesList)).EndInit();
			...
			((System.ComponentModel.ISupportInitialize)(this.repMembersListView)).EndInit();
		...
		public DevExpress.XtraBars.Ribbon.RibbonControl rcAirlinesList;
		...
		private DevExpress.XtraBars.Ribbon.RibbonPage rpAirlinesList;
		...
		private DevExpress.XtraGrid.GridControl gcAirlines;
		private DevExpress.XtraGrid.Views.Grid.GridView gvAirlines;
		private DevExpress.XtraGrid.Columns.GridColumn colAirlinesId;
		private DevExpress.XtraGrid.Columns.GridColumn colAirlineName;
		private DevExpress.XtraGrid.Columns.GridColumn colIntegerCode;
		private DevExpress.XtraGrid.Columns.GridColumn colAbrevCode;
		private DevExpress.XtraGrid.Columns.GridColumn colFlightCode;
		private DevExpress.XtraGrid.Columns.GridColumn colAirlineNameAWB;
		private DevExpress.XtraGrid.Columns.GridColumn colNationality;
		private DevExpress.XtraEditors.Repository.RepositoryItemLookUpEdit repNationalitiesList;
		private DevExpress.XtraGrid.Columns.GridColumn colGSAAgent;
		private DevExpress.XtraGrid.Columns.GridColumn colReportId;
		private DevExpress.XtraGrid.Columns.GridColumn colAirlineDate;
		private DevExpress.XtraEditors.Repository.RepositoryItemDateEdit repositoryItemDateEdit2;
		private DevExpress.XtraGrid.Columns.GridColumn colIataCode;
		private DevExpress.XtraGrid.Columns.GridColumn colAwbPrefix;
		...
		private DevExpress.XtraGrid.Views.Grid.GridView repMembersListView;
