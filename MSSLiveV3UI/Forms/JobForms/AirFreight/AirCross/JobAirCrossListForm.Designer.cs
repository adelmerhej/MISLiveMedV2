namespace MISLiveMed.UI.Forms.JobForms.AirFreight.AirCross
{
    partial class JobAirCrossListForm
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(JobAirCrossListForm));
			...
			this.gvAirCrossDetails = new DevExpress.XtraGrid.Views.Grid.GridView();
			...
			this.gcAirCross = new DevExpress.XtraGrid.GridControl();
			this.gvAirCross = new DevExpress.XtraGrid.Views.Grid.GridView();
			...
			this.rcJobAirCross = new DevExpress.XtraBars.Ribbon.RibbonControl();
			...
			this.rpJobAirCross = new DevExpress.XtraBars.Ribbon.RibbonPage();
			...
			((System.ComponentModel.ISupportInitialize)(this.gvAirCrossDetails)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.gcAirCross)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.gvAirCross)).BeginInit();
			...
			((System.ComponentModel.ISupportInitialize)(this.rcJobAirCross)).BeginInit();
			...
			// gvAirCrossDetails
			// 
			this.gvAirCrossDetails.Columns.AddRange(new DevExpress.XtraGrid.Columns.GridColumn[] {
            this.colDetailId,
            this.colDetailJobNo,
            this.colDetailBOL,
			...
			this.gvAirCrossDetails.GridControl = this.gcAirCross;
			this.gvAirCrossDetails.Name = "gvAirCrossDetails";
			// 
			// colDetailId
			// 
			...
			// gcAirCross
			// 
			this.gcAirCross.EmbeddedNavigator.Buttons.Append.Visible = false;
			this.gcAirCross.EmbeddedNavigator.Buttons.CancelEdit.Visible = false;
			this.gcAirCross.EmbeddedNavigator.Buttons.Edit.Visible = false;
			this.gcAirCross.EmbeddedNavigator.Buttons.EndEdit.Visible = false;
			this.gcAirCross.EmbeddedNavigator.Buttons.Remove.Visible = false;
			this.gcAirCross.EmbeddedNavigator.Margin = new System.Windows.Forms.Padding(3, 5, 3, 5);
			gridLevelNode1.LevelTemplate = this.gvAirCrossDetails;
			gridLevelNode1.RelationName = "FK_JobDetails";
			this.gcAirCross.LevelTree.Nodes.AddRange(new DevExpress.XtraGrid.GridLevelNode[] {
            gridLevelNode1});
			this.gcAirCross.Location = new System.Drawing.Point(12, 12);
			this.gcAirCross.MainView = this.gvAirCross;
			this.gcAirCross.Margin = new System.Windows.Forms.Padding(3, 4, 3, 4);
			this.gcAirCross.Name = "gcAirCross";
			this.gcAirCross.RepositoryItems.AddRange(new DevExpress.XtraEditors.Repository.RepositoryItem[] {
            this.repUsersList,
            this.repSalesList,
            this.repCustomers,
            ...
            this.repAgents,
            this.repJobTypes});
			this.gcAirCross.Size = new System.Drawing.Size(1412, 544);
			this.gcAirCross.TabIndex = 5;
			this.gcAirCross.UseEmbeddedNavigator = true;
			this.gcAirCross.ViewCollection.AddRange(new DevExpress.XtraGrid.Views.Base.BaseView[] {
            this.gvAirCross,
            this.gvAirCrossDetails});
			// 
			// gvAirCross
			// 
			this.gvAirCross.Columns.AddRange(new DevExpress.XtraGrid.Columns.GridColumn[] {
            this.colId,
            this.colRefNo,
            this.gridColumn1,
            this.colJobNo,
            ...
            this.colNotes});
			this.gvAirCross.DetailHeight = 458;
			this.gvAirCross.GridControl = this.gcAirCross;
			this.gvAirCross.GroupSummary.AddRange(new DevExpress.XtraGrid.GridSummaryItem[] {
            new DevExpress.XtraGrid.GridGroupSummaryItem(DevExpress.Data.SummaryItemType.Count, "Name", null, "")});
			this.gvAirCross.Name = "gvAirCross";
			this.gvAirCross.OptionsBehavior.Editable = false;
			this.gvAirCross.OptionsBehavior.ReadOnly = true;
			this.gvAirCross.OptionsFind.AlwaysVisible = true;
			this.gvAirCross.OptionsPrint.AutoWidth = false;
			this.gvAirCross.OptionsPrint.PrintHorzLines = false;
			this.gvAirCross.OptionsPrint.PrintVertLines = false;
			this.gvAirCross.OptionsView.ColumnAutoWidth = false;
			this.gvAirCross.OptionsView.ShowGroupedColumns = true;
			this.gvAirCross.OptionsView.ShowGroupPanel = false;
			// 
			// colId
			// 
			...
			// rcJobAirCross
			// 
			this.rcJobAirCross.EmptyAreaImageOptions.ImagePadding = new System.Windows.Forms.Padding(35, 39, 35, 39);
			this.rcJobAirCross.ExpandCollapseItem.Id = 0;
			this.rcJobAirCross.Items.AddRange(new DevExpress.XtraBars.BarItem[] {
            this.rcJobAirCross.ExpandCollapseItem,
            this.btnNew,
            this.btnDelete,
            this.barButtonItem1,
            this.barButtonItem2,
			...
			this.rcJobAirCross.Location = new System.Drawing.Point(0, 0);
			this.rcJobAirCross.Margin = new System.Windows.Forms.Padding(3, 4, 3, 4);
			this.rcJobAirCross.MaxItemId = 60;
			this.rcJobAirCross.MdiMergeStyle = DevExpress.XtraBars.Ribbon.RibbonMdiMergeStyle.Always;
			this.rcJobAirCross.Name = "rcJobAirCross";
			this.rcJobAirCross.OptionsMenuMinWidth = 385;
			this.rcJobAirCross.Pages.AddRange(new DevExpress.XtraBars.Ribbon.RibbonPage[] {
            this.rpJobAirCross,
            this.rpViewSettings});
			this.rcJobAirCross.Size = new System.Drawing.Size(1436, 193);
			this.rcJobAirCross.StatusBar = this.ribbonStatusBar1;
			// 
			// btnNew
			// 
			...
			// rpJobAirCross
			// 
			this.rpJobAirCross.Groups.AddRange(new DevExpress.XtraBars.Ribbon.RibbonPageGroup[] {
			...
			this.rpJobAirCross.Name = "rpJobAirCross";
			this.rpJobAirCross.Text = "Job Air Cross List";
			// 
			// ribbonPageGroup1
			// 
			...
			this.ribbonStatusBar1.Ribbon = this.rcJobAirCross;
			this.ribbonStatusBar1.Size = new System.Drawing.Size(1436, 30);
			// 
			// mainLayout
			// 
			this.mainLayout.Controls.Add(this.gcAirCross);
			...
			// layoutControlItem1
			// 
			this.layoutControlItem1.Control = this.gcAirCross;
			...
			this.Controls.Add(this.rcJobAirCross);
			this.Name = "JobAirCrossListForm";
			this.Ribbon = this.rcJobAirCross;
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.StatusBar = this.ribbonStatusBar1;
			this.Text = "Air Cross List";
			this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.JobAirCrossListForm_FormClosing);
			((System.ComponentModel.ISupportInitialize)(this.gvAirCrossDetails)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.gcAirCross)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.gvAirCross)).EndInit();
			...
			((System.ComponentModel.ISupportInitialize)(this.rcJobAirCross)).EndInit();
        ...
        public DevExpress.XtraBars.Ribbon.RibbonControl rcJobAirCross;
        ...
        private DevExpress.XtraBars.Ribbon.RibbonPage rpJobAirCross;
        ...
        private DevExpress.XtraGrid.GridControl gcAirCross;
        private DevExpress.XtraGrid.Views.Grid.GridView gvAirCrossDetails;
        ...
        private DevExpress.XtraGrid.Views.Grid.GridView gvAirCross;
