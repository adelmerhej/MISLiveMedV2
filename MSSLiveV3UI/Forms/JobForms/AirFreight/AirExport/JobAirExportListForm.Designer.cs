namespace MISLiveMed.UI.Forms.JobForms.AirFreight.AirExport
{
    partial class JobAirExportListForm
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(JobAirExportListForm));
			...
			DevExpress.Skins.SkinPaddingEdges skinPaddingEdges13 = new DevExpress.Skins.SkinPaddingEdges();
			DevExpress.Skins.SkinPaddingEdges skinPaddingEdges14 = new DevExpress.Skins.SkinPaddingEdges();
			...
			DevExpress.Skins.SkinPaddingEdges skinPaddingEdges17 = new DevExpress.Skins.SkinPaddingEdges();
			DevExpress.Skins.SkinPaddingEdges skinPaddingEdges18 = new DevExpress.Skins.SkinPaddingEdges();
			this.gvAirExportDetails = new DevExpress.XtraGrid.Views.Grid.GridView();
			...
			this.gcAirExports = new DevExpress.XtraGrid.GridControl();
			this.gvAirExports = new DevExpress.XtraGrid.Views.Grid.GridView();
			...
			this.rcJobAirExports = new DevExpress.XtraBars.Ribbon.RibbonControl();
			...
			this.rpJobAirExports = new DevExpress.XtraBars.Ribbon.RibbonPage();
			...
			((System.ComponentModel.ISupportInitialize)(this.gvAirExportDetails)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.gcAirExports)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.gvAirExports)).BeginInit();
			...
			((System.ComponentModel.ISupportInitialize)(this.rcJobAirExports)).BeginInit();
			...
			// gvAirExportDetails
			// 
			this.gvAirExportDetails.Columns.AddRange(new DevExpress.XtraGrid.Columns.GridColumn[] {
            this.colDetailId,
            this.colDetailJobNo,
            this.colDetailBOL,
			...
			this.gvAirExportDetails.GridControl = this.gcAirExports;
			this.gvAirExportDetails.Name = "gvAirExportDetails";
			// 
			// colDetailId
			// 
			...
			// gcAirExports
			// 
			this.gcAirExports.EmbeddedNavigator.Buttons.Append.Visible = false;
			this.gcAirExports.EmbeddedNavigator.Buttons.CancelEdit.Visible = false;
			this.gcAirExports.EmbeddedNavigator.Buttons.Edit.Visible = false;
			this.gcAirExports.EmbeddedNavigator.Buttons.EndEdit.Visible = false;
			this.gcAirExports.EmbeddedNavigator.Buttons.Remove.Visible = false;
			this.gcAirExports.EmbeddedNavigator.Margin = new System.Windows.Forms.Padding(3, 5, 3, 5);
			gridLevelNode1.LevelTemplate = this.gvAirExportDetails;
			gridLevelNode1.RelationName = "FK_JobDetails";
			this.gcAirExports.LevelTree.Nodes.AddRange(new DevExpress.XtraGrid.GridLevelNode[] {
            gridLevelNode1});
			this.gcAirExports.Location = new System.Drawing.Point(12, 12);
			this.gcAirExports.MainView = this.gvAirExports;
			this.gcAirExports.Margin = new System.Windows.Forms.Padding(3, 4, 3, 4);
			this.gcAirExports.Name = "gcAirExports";
			this.gcAirExports.RepositoryItems.AddRange(new DevExpress.XtraEditors.Repository.RepositoryItem[] {
            this.repUsersList,
            this.repSalesList,
            this.repCustomers,
            ...
            this.repAgents,
            this.repJobTypes});
			this.gcAirExports.Size = new System.Drawing.Size(1408, 541);
			this.gcAirExports.TabIndex = 5;
			this.gcAirExports.UseEmbeddedNavigator = true;
			this.gcAirExports.ViewCollection.AddRange(new DevExpress.XtraGrid.Views.Base.BaseView[] {
            this.gvAirExports,
            this.gvAirExportDetails});
			// 
			// gvAirExports
			// 
			this.gvAirExports.Columns.AddRange(new DevExpress.XtraGrid.Columns.GridColumn[] {
            this.colId,
            this.colRefNo,
            this.gridColumn1,
            this.colJobNo,
            ...
            this.colNotes});
			this.gvAirExports.DetailHeight = 458;
			this.gvAirExports.GridControl = this.gcAirExports;
			this.gvAirExports.GroupSummary.AddRange(new DevExpress.XtraGrid.GridSummaryItem[] {
            new DevExpress.XtraGrid.GridGroupSummaryItem(DevExpress.Data.SummaryItemType.Count, "Name", null, "")});
			this.gvAirExports.Name = "gvAirExports";
			this.gvAirExports.OptionsBehavior.Editable = false;
			this.gvAirExports.OptionsBehavior.ReadOnly = true;
			this.gvAirExports.OptionsFind.AlwaysVisible = true;
			this.gvAirExports.OptionsPrint.AutoWidth = false;
			this.gvAirExports.OptionsPrint.PrintHorzLines = false;
			this.gvAirExports.OptionsPrint.PrintVertLines = false;
			this.gvAirExports.OptionsView.ColumnAutoWidth = false;
			this.gvAirExports.OptionsView.ShowGroupedColumns = true;
			this.gvAirExports.OptionsView.ShowGroupPanel = false;
			// 
			// colId
			// 
			...
			this.repJobTypes.DisplayMember = "Description";
			this.repJobTypes.Name = "repJobTypes";
			this.repJobTypes.NullText = "";
			this.repJobTypes.ValueMember = "Id";
			// 
			// colSideId
			// 
			...
			// rcJobAirExports
			// 
			this.rcJobAirExports.EmptyAreaImageOptions.ImagePadding = new System.Windows.Forms.Padding(35, 39, 35, 39);
			this.rcJobAirExports.ExpandCollapseItem.Id = 0;
			this.rcJobAirExports.Items.AddRange(new DevExpress.XtraBars.BarItem[] {
            this.rcJobAirExports.ExpandCollapseItem,
            this.btnNew,
            this.btnDelete,
            this.barButtonItem1,
            this.barButtonItem2,
			...
			this.rcJobAirExports.Location = new System.Drawing.Point(0, 0);
			this.rcJobAirExports.Margin = new System.Windows.Forms.Padding(3, 4, 3, 4);
			this.rcJobAirExports.MaxItemId = 60;
			this.rcJobAirExports.MdiMergeStyle = DevExpress.XtraBars.Ribbon.RibbonMdiMergeStyle.Always;
			this.rcJobAirExports.Name = "rcJobAirExports";
			this.rcJobAirExports.OptionsMenuMinWidth = 385;
			this.rcJobAirExports.Pages.AddRange(new DevExpress.XtraBars.Ribbon.RibbonPage[] {
            this.rpJobAirExports,
            this.rpViewSettings});
			this.rcJobAirExports.Size = new System.Drawing.Size(1432, 193);
			this.rcJobAirExports.StatusBar = this.ribbonStatusBar1;
			// 
			// btnNew
			// 
			...
			galleryItemGroup7.Caption = "FilterGroup";
			galleryItem17.Caption = "Active Jobs";
			galleryItem17.ImageOptions.SvgImage = ((DevExpress.Utils.Svg.SvgImage)(resources.GetObject("resource.SvgImage")));
			galleryItem17.Value = "showActive";
			galleryItem18.Caption = "Closed Jobs";
			galleryItem18.ImageOptions.SvgImage = ((DevExpress.Utils.Svg.SvgImage)(resources.GetObject("resource.SvgImage1")));
			galleryItem18.Value = "showClosed";
			galleryItem19.Caption = "Cancelled Jobs";
			galleryItem19.ImageOptions.SvgImage = ((DevExpress.Utils.Svg.SvgImage)(resources.GetObject("resource.SvgImage2")));
			galleryItem19.Value = "showCancelled";
			galleryItem20.Caption = "All";
			galleryItem20.ImageOptions.SvgImage = ((DevExpress.Utils.Svg.SvgImage)(resources.GetObject("resource.SvgImage3")));
			galleryItem20.Value = "showAll";
			...
			skinPaddingEdges13.Bottom = -4;
			skinPaddingEdges13.Top = -4;
			this.rgFilterReports.Gallery.ItemImagePadding = skinPaddingEdges13;
			skinPaddingEdges14.Bottom = -1;
			skinPaddingEdges14.Top = -1;
			this.rgFilterReports.Gallery.ItemTextPadding = skinPaddingEdges14;
			...
			galleryItemGroup8.Caption = "groupSortingBy";
			galleryItem21.Caption = "Sort By Job No";
			galleryItem21.ImageOptions.SvgImage = ((DevExpress.Utils.Svg.SvgImage)(resources.GetObject("resource.SvgImage4")));
			galleryItem21.Value = "SortByJobNo";
			galleryItem22.Caption = "Sort By XONO";
			galleryItem22.ImageOptions.SvgImage = ((DevExpress.Utils.Svg.SvgImage)(resources.GetObject("resource.SvgImage5")));
			galleryItem22.Value = "SortByRefNo";
			...
			this.rgSortByReports.Gallery.ItemImagePadding = skinPaddingEdges15;
			skinPaddingEdges16.Bottom = -1;
			skinPaddingEdges16.Top = -1;
			this.rgSortByReports.Gallery.ItemTextPadding = skinPaddingEdges16;
			...
			galleryItem23.Caption = "Ascending";
			galleryItem23.Checked = true;
			galleryItem23.ImageOptions.SvgImage = ((DevExpress.Utils.Svg.SvgImage)(resources.GetObject("resource.SvgImage6")));
			galleryItem23.Value = "Ascending";
			galleryItem24.Caption = "Descending";
			galleryItem24.ImageOptions.SvgImage = ((DevExpress.Utils.Svg.SvgImage)(resources.GetObject("resource.SvgImage7")));
			galleryItem24.Value = "Descending";
			...
			skinPaddingEdges17.Bottom = -4;
			skinPaddingEdges17.Top = -4;
			this.rgOrderByReports.Gallery.ItemImagePadding = skinPaddingEdges17;
			skinPaddingEdges18.Bottom = -1;
			skinPaddingEdges18.Top = -1;
			this.rgOrderByReports.Gallery.ItemTextPadding = skinPaddingEdges18;
			...
			// rpJobAirExports
			// 
			this.rpJobAirExports.Groups.AddRange(new DevExpress.XtraBars.Ribbon.RibbonPageGroup[] {
			...
			this.rpJobAirExports.Name = "rpJobAirExports";
			this.rpJobAirExports.Text = "Job Air Export List";
			// 
			// ribbonPageGroup1
			// 
			...
			this.ribbonStatusBar1.Ribbon = this.rcJobAirExports;
			this.ribbonStatusBar1.Size = new System.Drawing.Size(1432, 30);
			// 
			// mainLayout
			// 
			this.mainLayout.Controls.Add(this.gcAirExports);
			this.mainLayout.Dock = System.Windows.Forms.DockStyle.Fill;
			this.mainLayout.Location = new System.Drawing.Point(0, 193);
			this.mainLayout.Name = "mainLayout";
			this.mainLayout.Root = this.Root;
			this.mainLayout.Size = new System.Drawing.Size(1432, 565);
			...
			this.Root.Name = "Root";
			this.Root.Size = new System.Drawing.Size(1432, 565);
			this.Root.TextVisible = false;
			// 
			// layoutControlItem1
			// 
			this.layoutControlItem1.Control = this.gcAirExports;
			this.layoutControlItem1.Location = new System.Drawing.Point(0, 0);
			this.layoutControlItem1.Name = "layoutControlItem1";
			this.layoutControlItem1.Size = new System.Drawing.Size(1412, 545);
			...
			this.Controls.Add(this.rcJobAirExports);
			this.Name = "JobAirExportListForm";
			this.Ribbon = this.rcJobAirExports;
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.StatusBar = this.ribbonStatusBar1;
			this.Text = "Air Export List";
			this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.JobAirExportListForm_FormClosing);
			((System.ComponentModel.ISupportInitialize)(this.gvAirExportDetails)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.gcAirExports)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.gvAirExports)).EndInit();
			...
			((System.ComponentModel.ISupportInitialize)(this.rcJobAirExports)).EndInit();
        ...
        public DevExpress.XtraBars.Ribbon.RibbonControl rcJobAirExports;
        ...
        private DevExpress.XtraBars.Ribbon.RibbonPage rpJobAirExports;
        ...
        private DevExpress.XtraGrid.GridControl gcAirExports;
        private DevExpress.XtraGrid.Views.Grid.GridView gvAirExportDetails;
        ...
        private DevExpress.XtraGrid.Views.Grid.GridView gvAirExports;
