...
{
    partial class JobAirImportListForm
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(JobAirImportListForm));
			...
			this.gvAirImportDetails = new DevExpress.XtraGrid.Views.Grid.GridView();
			...
			this.gcAirImports = new DevExpress.XtraGrid.GridControl();
			this.gvAirImports = new DevExpress.XtraGrid.Views.Grid.GridView();
			...
			this.rcJobAirImports = new DevExpress.XtraBars.Ribbon.RibbonControl();
			...
			this.rpJobAirImports = new DevExpress.XtraBars.Ribbon.RibbonPage();
			...
			this.bsAirImportJobs = new System.Windows.Forms.BindingSource(this.components);
			...
			((System.ComponentModel.ISupportInitialize)(this.gvAirImportDetails)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.gcAirImports)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.gvAirImports)).BeginInit();
			...
			((System.ComponentModel.ISupportInitialize)(this.rcJobAirImports)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.bsAirImportJobs)).BeginInit();
			...
			// gvAirImportDetails
			// 
			this.gvAirImportDetails.Columns.AddRange(new DevExpress.XtraGrid.Columns.GridColumn[] {
            this.colDetailId,
            this.colDetailJobNo,
            this.colDetailBOL,
			...
			this.gvAirImportDetails.GridControl = this.gcAirImports;
			this.gvAirImportDetails.Name = "gvAirImportDetails";
			// 
			// colDetailId
			// 
			...
			// gcAirImports
			// 
			this.gcAirImports.EmbeddedNavigator.Buttons.Append.Visible = false;
			this.gcAirImports.EmbeddedNavigator.Buttons.CancelEdit.Visible = false;
			this.gcAirImports.EmbeddedNavigator.Buttons.Edit.Visible = false;
			this.gcAirImports.EmbeddedNavigator.Buttons.EndEdit.Visible = false;
			this.gcAirImports.EmbeddedNavigator.Buttons.Remove.Visible = false;
			this.gcAirImports.EmbeddedNavigator.Margin = new System.Windows.Forms.Padding(3, 5, 3, 5);
			gridLevelNode2.LevelTemplate = this.gvAirImportDetails;
			gridLevelNode2.RelationName = "FK_JobDetails";
			this.gcAirImports.LevelTree.Nodes.AddRange(new DevExpress.XtraGrid.GridLevelNode[] {
            gridLevelNode2});
			this.gcAirImports.Location = new System.Drawing.Point(12, 12);
			this.gcAirImports.MainView = this.gvAirImports;
			this.gcAirImports.Margin = new System.Windows.Forms.Padding(3, 4, 3, 4);
			this.gcAirImports.Name = "gcAirImports";
			this.gcAirImports.RepositoryItems.AddRange(new DevExpress.XtraEditors.Repository.RepositoryItem[] {
            this.repUsersList,
            this.repSalesList,
            this.repCustomers,
            ...
            this.repAgents,
            this.repJobTypes});
			this.gcAirImports.Size = new System.Drawing.Size(1386, 518);
			this.gcAirImports.TabIndex = 5;
			this.gcAirImports.UseEmbeddedNavigator = true;
			this.gcAirImports.ViewCollection.AddRange(new DevExpress.XtraGrid.Views.Base.BaseView[] {
            this.gvAirImports,
            this.gvAirImportDetails});
			// 
			// gvAirImports
			// 
			this.gvAirImports.Columns.AddRange(new DevExpress.XtraGrid.Columns.GridColumn[] {
            this.colId,
            this.colRefNo,
            this.gridColumn1,
            this.colJobNo,
            ...
            this.colNotes});
			this.gvAirImports.DetailHeight = 458;
			this.gvAirImports.GridControl = this.gcAirImports;
			this.gvAirImports.GroupSummary.AddRange(new DevExpress.XtraGrid.GridSummaryItem[] {
            new DevExpress.XtraGrid.GridGroupSummaryItem(DevExpress.Data.SummaryItemType.Count, "Name", null, "")});
			this.gvAirImports.Name = "gvAirImports";
			this.gvAirImports.OptionsBehavior.Editable = false;
			this.gvAirImports.OptionsBehavior.ReadOnly = true;
			this.gvAirImports.OptionsFind.AlwaysVisible = true;
			this.gvAirImports.OptionsPrint.AutoWidth = false;
			this.gvAirImports.OptionsPrint.PrintHorzLines = false;
			this.gvAirImports.OptionsPrint.PrintVertLines = false;
			this.gvAirImports.OptionsView.ColumnAutoWidth = false;
			this.gvAirImports.OptionsView.ShowGroupedColumns = true;
			this.gvAirImports.OptionsView.ShowGroupPanel = false;
			// 
			// colId
			// 
			...
			// rcJobAirImports
			// 
			this.rcJobAirImports.EmptyAreaImageOptions.ImagePadding = new System.Windows.Forms.Padding(35, 39, 35, 39);
			this.rcJobAirImports.ExpandCollapseItem.Id = 0;
			this.rcJobAirImports.Items.AddRange(new DevExpress.XtraBars.BarItem[] {
            this.rcJobAirImports.ExpandCollapseItem,
            this.btnNew,
            this.btnDelete,
            this.barButtonItem1,
            this.barButtonItem2,
			...
			this.rcJobAirImports.Location = new System.Drawing.Point(0, 0);
			this.rcJobAirImports.Margin = new System.Windows.Forms.Padding(3, 4, 3, 4);
			this.rcJobAirImports.MaxItemId = 60;
			this.rcJobAirImports.MdiMergeStyle = DevExpress.XtraBars.Ribbon.RibbonMdiMergeStyle.Always;
			this.rcJobAirImports.Name = "rcJobAirImports";
			this.rcJobAirImports.OptionsMenuMinWidth = 385;
			this.rcJobAirImports.Pages.AddRange(new DevExpress.XtraBars.Ribbon.RibbonPage[] {
            this.rpJobAirImports,
            this.rpViewSettings});
			this.rcJobAirImports.Size = new System.Drawing.Size(1410, 193);
			this.rcJobAirImports.StatusBar = this.ribbonStatusBar1;
			// 
			// btnNew
			// 
			...
			galleryItemGroup4.Caption = "FilterGroup";
			galleryItem9.Caption = "Active Jobs";
			galleryItem9.ImageOptions.SvgImage = ((DevExpress.Utils.Svg.SvgImage)(resources.GetObject("resource.SvgImage")));
			galleryItem9.Value = "showActive";
			galleryItem10.Caption = "Closed Jobs";
			galleryItem10.ImageOptions.SvgImage = ((DevExpress.Utils.Svg.SvgImage)(resources.GetObject("resource.SvgImage1")));
			galleryItem10.Value = "showClosed";
			galleryItem11.Caption = "Cancelled Jobs";
			galleryItem11.ImageOptions.SvgImage = ((DevExpress.Utils.Svg.SvgImage)(resources.GetObject("resource.SvgImage2")));
			galleryItem11.Value = "showCancelled";
			galleryItem12.Caption = "All";
			galleryItem12.ImageOptions.SvgImage = ((DevExpress.Utils.Svg.SvgImage)(resources.GetObject("resource.SvgImage3")));
			galleryItem12.Value = "showAll";
			...
			this.rgFilterReports.Gallery.ItemImagePadding = skinPaddingEdges7;
			skinPaddingEdges8.Bottom = -1;
			skinPaddingEdges8.Top = -1;
			this.rgFilterReports.Gallery.ItemTextPadding = skinPaddingEdges8;
			...
			galleryItemGroup5.Caption = "groupSortingBy";
			galleryItem13.Caption = "Sort By Job No";
			galleryItem13.ImageOptions.SvgImage = ((DevExpress.Utils.Svg.SvgImage)(resources.GetObject("resource.SvgImage4")));
			galleryItem13.Value = "SortByJobNo";
			galleryItem14.Caption = "Sort By XONO";
			galleryItem14.ImageOptions.SvgImage = ((DevExpress.Utils.Svg.SvgImage)(resources.GetObject("resource.SvgImage5")));
			galleryItem14.Value = "SortByXoNo";
			...
			skinPaddingEdges9.Bottom = -4;
			skinPaddingEdges9.Top = -4;
			this.rgSortByReports.Gallery.ItemImagePadding = skinPaddingEdges9;
			skinPaddingEdges10.Bottom = -1;
			skinPaddingEdges10.Top = -1;
			this.rgSortByReports.Gallery.ItemTextPadding = skinPaddingEdges10;
			...
			galleryItem15.Caption = "Ascending";
			galleryItem15.Checked = true;
			galleryItem15.ImageOptions.SvgImage = ((DevExpress.Utils.Svg.SvgImage)(resources.GetObject("resource.SvgImage6")));
			galleryItem15.Value = "Ascending";
			galleryItem16.Caption = "Descending";
			galleryItem16.ImageOptions.SvgImage = ((DevExpress.Utils.Svg.SvgImage)(resources.GetObject("resource.SvgImage7")));
			galleryItem16.Value = "Descending";
			...
			skinPaddingEdges11.Bottom = -4;
			skinPaddingEdges11.Top = -4;
			this.rgOrderByReports.Gallery.ItemImagePadding = skinPaddingEdges11;
			skinPaddingEdges12.Bottom = -1;
			skinPaddingEdges12.Top = -1;
			this.rgOrderByReports.Gallery.ItemTextPadding = skinPaddingEdges12;
			...
			// rpJobAirImports
			// 
			this.rpJobAirImports.Groups.AddRange(new DevExpress.XtraBars.Ribbon.RibbonPageGroup[] {
			...
			this.rpJobAirImports.Name = "rpJobAirImports";
			this.rpJobAirImports.Text = "Job Air Import List";
			// 
			// ribbonPageGroup1
			// 
			...
			this.rpgDepartments.ItemLinks.Add(this.cboSalesList);
			...
			this.ribbonStatusBar1.Ribbon = this.rcJobAirImports;
			this.ribbonStatusBar1.Size = new System.Drawing.Size(1410, 30);
			// 
			// mainLayout
			// 
			this.mainLayout.Controls.Add(this.gcAirImports);
			this.mainLayout.Dock = System.Windows.Forms.DockStyle.Fill;
			this.mainLayout.Location = new System.Drawing.Point(0, 193);
			this.mainLayout.Name = "mainLayout";
			this.mainLayout.Root = this.Root;
			this.mainLayout.Size = new System.Drawing.Size(1410, 542);
			...
			this.Root.Name = "Root";
			this.Root.Size = new System.Drawing.Size(1410, 542);
			this.Root.TextVisible = false;
			// 
			// layoutControlItem1
			// 
			this.layoutControlItem1.Control = this.gcAirImports;
			this.layoutControlItem1.Location = new System.Drawing.Point(0, 0);
			this.layoutControlItem1.Name = "layoutControlItem1";
			this.layoutControlItem1.Size = new System.Drawing.Size(1390, 522);
			...
			// 
			// JobAirImportListForm
			// 
			this.AutoScaleDimensions = new System.Drawing.SizeF(7F, 16F);
			this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
			this.ClientSize = new System.Drawing.Size(1410, 765);
			this.Controls.Add(this.mainLayout);
			this.Controls.Add(this.ribbonStatusBar1);
			this.Controls.Add(this.rcJobAirImports);
			this.Name = "JobAirImportListForm";
			this.Ribbon = this.rcJobAirImports;
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.StatusBar = this.ribbonStatusBar1;
			this.Text = "Air Import List";
			this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.JobAirImportListForm_FormClosing);
			((System.ComponentModel.ISupportInitialize)(this.gvAirImportDetails)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.gcAirImports)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.gvAirImports)).EndInit();
			...
			((System.ComponentModel.ISupportInitialize)(this.rcJobAirImports)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.bsAirImportJobs)).EndInit();
        ...
        #endregion
        public DevExpress.XtraBars.Ribbon.RibbonControl rcJobAirImports;
        ...
        private DevExpress.XtraBars.Ribbon.RibbonPage rpJobAirImports;
        ...
        private System.Windows.Forms.BindingSource bsAirImportJobs;
        private DevExpress.XtraDataLayout.DataLayoutControl mainLayout;
        private DevExpress.XtraGrid.GridControl gcAirImports;
        private DevExpress.XtraGrid.Views.Grid.GridView gvAirImportDetails;
        ...
        private DevExpress.XtraGrid.Views.Grid.GridView gvAirImports;
