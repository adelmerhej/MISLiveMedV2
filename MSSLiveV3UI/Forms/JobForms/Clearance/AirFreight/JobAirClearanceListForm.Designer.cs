namespace MISLiveMed.UI.Forms.JobForms.Clearance.AirFreight
{
    partial class JobAirClearanceListForm
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(JobAirClearanceListForm));
			...
			this.gvAirClearanceDetails = new DevExpress.XtraGrid.Views.Grid.GridView();
			...
			this.gcAirClearance = new DevExpress.XtraGrid.GridControl();
			this.gvAirClearance = new DevExpress.XtraGrid.Views.Grid.GridView();
			...
			this.rcJobAirClearance = new DevExpress.XtraBars.Ribbon.RibbonControl();
			...
			this.rpJobAirClearance = new DevExpress.XtraBars.Ribbon.RibbonPage();
			...
			((System.ComponentModel.ISupportInitialize)(this.gvAirClearanceDetails)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.gcAirClearance)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.gvAirClearance)).BeginInit();
			...
			((System.ComponentModel.ISupportInitialize)(this.rcJobAirClearance)).BeginInit();
			...
			this.SuspendLayout();
			// 
			// gvAirClearanceDetails
			// 
			this.gvAirClearanceDetails.Columns.AddRange(new DevExpress.XtraGrid.Columns.GridColumn[] {
            this.colDetailId,
            this.colDetailJobNo,
            this.colDetailBOL,
			...
			this.gvAirClearanceDetails.GridControl = this.gcAirClearance;
			this.gvAirClearanceDetails.Name = "gvAirClearanceDetails";
			// 
			// colDetailId
			// 
			...
			// gcAirClearance
			// 
			this.gcAirClearance.EmbeddedNavigator.Buttons.Append.Visible = false;
			this.gcAirClearance.EmbeddedNavigator.Buttons.CancelEdit.Visible = false;
			this.gcAirClearance.EmbeddedNavigator.Buttons.Edit.Visible = false;
			this.gcAirClearance.EmbeddedNavigator.Buttons.EndEdit.Visible = false;
			this.gcAirClearance.EmbeddedNavigator.Buttons.Remove.Visible = false;
			this.gcAirClearance.EmbeddedNavigator.Margin = new System.Windows.Forms.Padding(3, 5, 3, 5);
			gridLevelNode2.LevelTemplate = this.gvAirClearanceDetails;
			gridLevelNode2.RelationName = "FK_JobDetails";
			this.gcAirClearance.LevelTree.Nodes.AddRange(new DevExpress.XtraGrid.GridLevelNode[] {
            gridLevelNode2});
			this.gcAirClearance.Location = new System.Drawing.Point(12, 12);
			this.gcAirClearance.MainView = this.gvAirClearance;
			this.gcAirClearance.Margin = new System.Windows.Forms.Padding(3, 4, 3, 4);
			this.gcAirClearance.Name = "gcAirClearance";
			this.gcAirClearance.RepositoryItems.AddRange(new DevExpress.XtraEditors.Repository.RepositoryItem[] {
            this.repUsersList,
            this.repSalesList,
            this.repCustomers,
            ...
            this.repAgents,
            this.repJobTypes});
			this.gcAirClearance.Size = new System.Drawing.Size(1414, 516);
			this.gcAirClearance.TabIndex = 5;
			this.gcAirClearance.UseEmbeddedNavigator = true;
			this.gcAirClearance.ViewCollection.AddRange(new DevExpress.XtraGrid.Views.Base.BaseView[] {
            this.gvAirClearance,
            this.gvAirClearanceDetails});
			// 
			// gvAirClearance
			// 
			this.gvAirClearance.Columns.AddRange(new DevExpress.XtraGrid.Columns.GridColumn[] {
            this.colId,
            this.colRefNo,
            this.gridColumn1,
            this.colJobNo,
            ...
            this.colNotes});
			this.gvAirClearance.DetailHeight = 458;
			this.gvAirClearance.GridControl = this.gcAirClearance;
			this.gvAirClearance.GroupSummary.AddRange(new DevExpress.XtraGrid.GridSummaryItem[] {
            new DevExpress.XtraGrid.GridGroupSummaryItem(DevExpress.Data.SummaryItemType.Count, "Name", null, "")});
			this.gvAirClearance.Name = "gvAirClearance";
			this.gvAirClearance.OptionsBehavior.Editable = false;
			this.gvAirClearance.OptionsBehavior.ReadOnly = true;
			this.gvAirClearance.OptionsFind.AlwaysVisible = true;
			this.gvAirClearance.OptionsPrint.AutoWidth = false;
			this.gvAirClearance.OptionsPrint.PrintHorzLines = false;
			this.gvAirClearance.OptionsPrint.PrintVertLines = false;
			this.gvAirClearance.OptionsView.ColumnAutoWidth = false;
			this.gvAirClearance.OptionsView.ShowGroupedColumns = true;
			this.gvAirClearance.OptionsView.ShowGroupPanel = false;
			// 
			// colId
			// 
			...
			// rcJobAirClearance
			// 
			this.rcJobAirClearance.EmptyAreaImageOptions.ImagePadding = new System.Windows.Forms.Padding(35, 39, 35, 39);
			this.rcJobAirClearance.ExpandCollapseItem.Id = 0;
			this.rcJobAirClearance.Items.AddRange(new DevExpress.XtraBars.BarItem[] {
            this.rcJobAirClearance.ExpandCollapseItem,
            this.btnNew,
            this.btnDelete,
            this.barButtonItem1,
            this.barButtonItem2,
			...
			this.rcJobAirClearance.Location = new System.Drawing.Point(0, 0);
			this.rcJobAirClearance.Margin = new System.Windows.Forms.Padding(3, 4, 3, 4);
			this.rcJobAirClearance.MaxItemId = 60;
			this.rcJobAirClearance.MdiMergeStyle = DevExpress.XtraBars.Ribbon.RibbonMdiMergeStyle.Always;
			this.rcJobAirClearance.Name = "rcJobAirClearance";
			this.rcJobAirClearance.OptionsMenuMinWidth = 385;
			this.rcJobAirClearance.Pages.AddRange(new DevExpress.XtraBars.Ribbon.RibbonPage[] {
            this.rpJobAirClearance,
            this.rpViewSettings});
			this.rcJobAirClearance.Size = new System.Drawing.Size(1438, 193);
			this.rcJobAirClearance.StatusBar = this.ribbonStatusBar1;
			// 
			// btnNew
			// 
			...
			// rpJobAirClearance
			// 
			this.rpJobAirClearance.Groups.AddRange(new DevExpress.XtraBars.Ribbon.RibbonPageGroup[] {
			...
			this.rpJobAirClearance.Name = "rpJobAirClearance";
			this.rpJobAirClearance.Text = "Job Air Clearance List";
			// 
			// ribbonPageGroup1
			// 
			...
			this.ribbonStatusBar1.Ribbon = this.rcJobAirClearance;
			this.ribbonStatusBar1.Size = new System.Drawing.Size(1438, 30);
			// 
			// mainLayout
			// 
			this.mainLayout.Controls.Add(this.gcAirClearance);
			this.mainLayout.Dock = System.Windows.Forms.DockStyle.Fill;
			this.mainLayout.Location = new System.Drawing.Point(0, 193);
			this.mainLayout.Name = "mainLayout";
			this.mainLayout.Root = this.Root;
			this.mainLayout.Size = new System.Drawing.Size(1438, 540);
			...
			this.Root.Name = "Root";
			this.Root.Size = new System.Drawing.Size(1438, 540);
			this.Root.TextVisible = false;
			// 
			// layoutControlItem1
			// 
			this.layoutControlItem1.Control = this.gcAirClearance;
			this.layoutControlItem1.Location = new System.Drawing.Point(0, 0);
			this.layoutControlItem1.Name = "layoutControlItem1";
			this.layoutControlItem1.Size = new System.Drawing.Size(1418, 520);
			...
			// 
			// JobAirClearanceListForm
			// 
			this.AutoScaleDimensions = new System.Drawing.SizeF(7F, 16F);
			this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
			this.ClientSize = new System.Drawing.Size(1438, 763);
			this.Controls.Add(this.mainLayout);
			this.Controls.Add(this.ribbonStatusBar1);
			this.Controls.Add(this.rcJobAirClearance);
			this.Name = "JobAirClearanceListForm";
			this.Ribbon = this.rcJobAirClearance;
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.StatusBar = this.ribbonStatusBar1;
			this.Text = "Air Clearance List";
			this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.JobAirClearanceListForm_FormClosing);
			((System.ComponentModel.ISupportInitialize)(this.gvAirClearanceDetails)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.gcAirClearance)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.gvAirClearance)).EndInit();
			...
			((System.ComponentModel.ISupportInitialize)(this.rcJobAirClearance)).EndInit();
        ...
        #endregion
        public DevExpress.XtraBars.Ribbon.RibbonControl rcJobAirClearance;
        ...
        private DevExpress.XtraBars.Ribbon.RibbonPage rpJobAirClearance;
        ...
        private DevExpress.XtraGrid.GridControl gcAirClearance;
        private DevExpress.XtraGrid.Views.Grid.GridView gvAirClearanceDetails;
        ...
        private DevExpress.XtraGrid.Views.Grid.GridView gvAirClearance;
