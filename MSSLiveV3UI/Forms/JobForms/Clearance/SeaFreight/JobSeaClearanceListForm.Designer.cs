namespace MISLiveMed.UI.Forms.JobForms.Clearance.SeaFreight
{
    partial class JobSeaClearanceListForm
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(JobSeaClearanceListForm));
			...
			this.gvSeaClearanceDetails = new DevExpress.XtraGrid.Views.Grid.GridView();
			...
			this.gcSeaClearance = new DevExpress.XtraGrid.GridControl();
			this.gvSeaClearance = new DevExpress.XtraGrid.Views.Grid.GridView();
			...
			this.rcJobSeaClearance = new DevExpress.XtraBars.Ribbon.RibbonControl();
			...
			this.rpJobSeaClearance = new DevExpress.XtraBars.Ribbon.RibbonPage();
			...
			((System.ComponentModel.ISupportInitialize)(this.gvSeaClearanceDetails)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.gcSeaClearance)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.gvSeaClearance)).BeginInit();
			...
			((System.ComponentModel.ISupportInitialize)(this.rcJobSeaClearance)).BeginInit();
			...
			this.SuspendLayout();
			// 
			// gvSeaClearanceDetails
			// 
			this.gvSeaClearanceDetails.Columns.AddRange(new DevExpress.XtraGrid.Columns.GridColumn[] {
            this.colDetailId,
            this.colDetailJobNo,
            this.colDetailBOL,
			...
			this.gvSeaClearanceDetails.GridControl = this.gcSeaClearance;
			this.gvSeaClearanceDetails.Name = "gvSeaClearanceDetails";
			// 
			// colDetailId
			// 
			...
			// gcSeaClearance
			// 
			this.gcSeaClearance.EmbeddedNavigator.Buttons.Append.Visible = false;
			this.gcSeaClearance.EmbeddedNavigator.Buttons.CancelEdit.Visible = false;
			this.gcSeaClearance.EmbeddedNavigator.Buttons.Edit.Visible = false;
			this.gcSeaClearance.EmbeddedNavigator.Buttons.EndEdit.Visible = false;
			this.gcSeaClearance.EmbeddedNavigator.Buttons.Remove.Visible = false;
			this.gcSeaClearance.EmbeddedNavigator.Margin = new System.Windows.Forms.Padding(3, 5, 3, 5);
			gridLevelNode2.LevelTemplate = this.gvSeaClearanceDetails;
			gridLevelNode2.RelationName = "FK_JobDetails";
			this.gcSeaClearance.LevelTree.Nodes.AddRange(new DevExpress.XtraGrid.GridLevelNode[] {
            gridLevelNode2});
			this.gcSeaClearance.Location = new System.Drawing.Point(12, 12);
			this.gcSeaClearance.MainView = this.gvSeaClearance;
			this.gcSeaClearance.Margin = new System.Windows.Forms.Padding(3, 4, 3, 4);
			this.gcSeaClearance.Name = "gcSeaClearance";
			this.gcSeaClearance.RepositoryItems.AddRange(new DevExpress.XtraEditors.Repository.RepositoryItem[] {
            this.repUsersList,
            this.repSalesList,
            this.repCustomers,
            ...
            this.repAgents,
            this.repJobTypes});
			this.gcSeaClearance.Size = new System.Drawing.Size(1406, 535);
			this.gcSeaClearance.TabIndex = 5;
			this.gcSeaClearance.UseEmbeddedNavigator = true;
			this.gcSeaClearance.ViewCollection.AddRange(new DevExpress.XtraGrid.Views.Base.BaseView[] {
            this.gvSeaClearance,
            this.gvSeaClearanceDetails});
			// 
			// gvSeaClearance
			// 
			this.gvSeaClearance.Columns.AddRange(new DevExpress.XtraGrid.Columns.GridColumn[] {
            this.colId,
            this.colRefNo,
            this.gridColumn1,
            this.colJobNo,
            ...
            this.colNotes});
			this.gvSeaClearance.DetailHeight = 458;
			this.gvSeaClearance.GridControl = this.gcSeaClearance;
			this.gvSeaClearance.GroupSummary.AddRange(new DevExpress.XtraGrid.GridSummaryItem[] {
            new DevExpress.XtraGrid.GridGroupSummaryItem(DevExpress.Data.SummaryItemType.Count, "Name", null, "")});
			this.gvSeaClearance.Name = "gvSeaClearance";
			this.gvSeaClearance.OptionsBehavior.Editable = false;
			this.gvSeaClearance.OptionsBehavior.ReadOnly = true;
			this.gvSeaClearance.OptionsFind.AlwaysVisible = true;
			this.gvSeaClearance.OptionsPrint.AutoWidth = false;
			this.gvSeaClearance.OptionsPrint.PrintHorzLines = false;
			this.gvSeaClearance.OptionsPrint.PrintVertLines = false;
			this.gvSeaClearance.OptionsView.ColumnAutoWidth = false;
			this.gvSeaClearance.OptionsView.ShowGroupedColumns = true;
			this.gvSeaClearance.OptionsView.ShowGroupPanel = false;
			// 
			// colId
			// 
			...
			// rcJobSeaClearance
			// 
			this.rcJobSeaClearance.EmptyAreaImageOptions.ImagePadding = new System.Windows.Forms.Padding(35, 39, 35, 39);
			this.rcJobSeaClearance.ExpandCollapseItem.Id = 0;
			this.rcJobSeaClearance.Items.AddRange(new DevExpress.XtraBars.BarItem[] {
            this.rcJobSeaClearance.ExpandCollapseItem,
            this.btnNew,
            this.btnDelete,
            this.barButtonItem1,
            this.barButtonItem2,
			...
			this.rcJobSeaClearance.Location = new System.Drawing.Point(0, 0);
			this.rcJobSeaClearance.Margin = new System.Windows.Forms.Padding(3, 4, 3, 4);
			this.rcJobSeaClearance.MaxItemId = 60;
			this.rcJobSeaClearance.MdiMergeStyle = DevExpress.XtraBars.Ribbon.RibbonMdiMergeStyle.Always;
			this.rcJobSeaClearance.Name = "rcJobSeaClearance";
			this.rcJobSeaClearance.OptionsMenuMinWidth = 385;
			this.rcJobSeaClearance.Pages.AddRange(new DevExpress.XtraBars.Ribbon.RibbonPage[] {
            this.rpJobSeaClearance,
            this.rpViewSettings});
			this.rcJobSeaClearance.Size = new System.Drawing.Size(1430, 193);
			this.rcJobSeaClearance.StatusBar = this.ribbonStatusBar1;
			// 
			// btnNew
			// 
			...
			galleryItem14.Value = "SortByRefNo";
			...
			// rpJobSeaClearance
			// 
			this.rpJobSeaClearance.Groups.AddRange(new DevExpress.XtraBars.Ribbon.RibbonPageGroup[] {
			...
			this.rpJobSeaClearance.Name = "rpJobSeaClearance";
			this.rpJobSeaClearance.Text = "Job Sea Clearance List";
			// 
			// ribbonPageGroup1
			// 
			...
			this.ribbonStatusBar1.Ribbon = this.rcJobSeaClearance;
			this.ribbonStatusBar1.Size = new System.Drawing.Size(1430, 30);
			// 
			// mainLayout
			// 
			this.mainLayout.Controls.Add(this.gcSeaClearance);
			this.mainLayout.Dock = System.Windows.Forms.DockStyle.Fill;
			this.mainLayout.Location = new System.Drawing.Point(0, 193);
			this.mainLayout.Name = "mainLayout";
			this.mainLayout.Root = this.Root;
			this.mainLayout.Size = new System.Drawing.Size(1430, 559);
			...
			this.Root.Name = "Root";
			this.Root.Size = new System.Drawing.Size(1430, 559);
			this.Root.TextVisible = false;
			// 
			// layoutControlItem1
			// 
			this.layoutControlItem1.Control = this.gcSeaClearance;
			this.layoutControlItem1.Location = new System.Drawing.Point(0, 0);
			this.layoutControlItem1.Name = "layoutControlItem1";
			this.layoutControlItem1.Size = new System.Drawing.Size(1410, 539);
			...
			this.Controls.Add(this.rcJobSeaClearance);
			this.Name = "JobSeaClearanceListForm";
			this.Ribbon = this.rcJobSeaClearance;
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.StatusBar = this.ribbonStatusBar1;
			this.Text = "Sea Clearance List";
			this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.JobSeaClearanceListForm_FormClosing);
			((System.ComponentModel.ISupportInitialize)(this.gvSeaClearanceDetails)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.gcSeaClearance)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.gvSeaClearance)).EndInit();
			...
			((System.ComponentModel.ISupportInitialize)(this.rcJobSeaClearance)).EndInit();
        ...
        public DevExpress.XtraBars.Ribbon.RibbonControl rcJobSeaClearance;
        ...
        private DevExpress.XtraBars.Ribbon.RibbonPage rpJobSeaClearance;
        ...
        private DevExpress.XtraGrid.GridControl gcSeaClearance;
        private DevExpress.XtraGrid.Views.Grid.GridView gvSeaClearanceDetails;
        ...
        private DevExpress.XtraGrid.Views.Grid.GridView gvSeaClearance;
