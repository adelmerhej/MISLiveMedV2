...
{
    partial class JobSeaExportListForm
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
			...
			this.rpJobSeaExport = new DevExpress.XtraBars.Ribbon.RibbonPage();
			...
			// rcJobSeaExport
			// 
			this.rcJobSeaExport.EmptyAreaImageOptions.ImagePadding = new System.Windows.Forms.Padding(35, 39, 35, 39);
			this.rcJobSeaExport.ExpandCollapseItem.Id = 0;
			this.rcJobSeaExport.Items.AddRange(new DevExpress.XtraBars.BarItem[] {
            this.rcJobSeaExport.ExpandCollapseItem,
            this.btnNew,
            this.btnDelete,
            this.barButtonItem1,
            this.barButtonItem2,
			...
			this.rcJobSeaExport.Location = new System.Drawing.Point(0, 0);
			this.rcJobSeaExport.Margin = new System.Windows.Forms.Padding(3, 4, 3, 4);
			this.rcJobSeaExport.MaxItemId = 60;
			this.rcJobSeaExport.MdiMergeStyle = DevExpress.XtraBars.Ribbon.RibbonMdiMergeStyle.Always;
			this.rcJobSeaExport.Name = "rcJobSeaExport";
			this.rcJobSeaExport.OptionsMenuMinWidth = 385;
			...
			// rpJobSeaExport
			// 
			this.rpJobSeaExport.Groups.AddRange(new DevExpress.XtraBars.Ribbon.RibbonPageGroup[] {
			...
			this.rpJobSeaExport.Name = "rpJobSeaExport";
			this.rpJobSeaExport.Text = "Job Sea Export List";
			// 
			// ribbonPageGroup1
			// 
			...
			this.ribbonStatusBar1.Ribbon = this.rcJobSeaExport;
			...
			this.Root.Name = "Root";
			this.Root.Size = new System.Drawing.Size(1445, 565);
