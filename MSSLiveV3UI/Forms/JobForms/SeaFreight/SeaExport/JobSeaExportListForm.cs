...
namespace MISLiveMed.UI.Forms.JobForms.SeaFreight.SeaExport
{
    public partial class JobSeaExportListForm : RibbonForm, IFormWithRibbon
	{
        ...
        {
	        LayoutsStyle.LoadLayoutGrid(gvSeaExports, CurrentUser.UserName);
        }
		...
		private void btnResetGridStyle_ItemClick(object sender, ItemClickEventArgs e)
		{
			...
			{
				_resetMenu = true;
				LayoutsStyle.ResetLayoutGrid(gvSeaExports, CurrentUser.UserName);
			}
		}
		...
		private void JobSeaExportListForm_FormClosing(object sender, FormClosingEventArgs e)
		{
			if (!_resetMenu)
			{
				LayoutsStyle.SaveLayoutGrid(gvSeaExports, CurrentUser.UserName);
			}
		}
