...
{
	partial class JobSeaExportHblEditForm
	{
		/// <summary>
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(JobSeaExportHblEditForm));
			...
			this.rpHblDetailEdit = new DevExpress.XtraBars.Ribbon.RibbonPage();
            ...
            this.rpHblDetailEdit});
			this.ribbonControl.Size = new System.Drawing.Size(1373, 193);
			...
			// rpHblDetailEdit
			// 
			this.rpHblDetailEdit.Groups.AddRange(new DevExpress.XtraBars.Ribbon.RibbonPageGroup[] {
			...
			this.rpHblDetailEdit.Name = "rpHblDetailEdit";
			this.rpHblDetailEdit.Text = "Edit Detail HBL";
			// 
			// ribbonPageGroup8
			// 
			...
			this.ribbonStatusBar1.Size = new System.Drawing.Size(1373, 30);
			// 
			// JobSeaExportHblEditForm
			// 
			...
			this.Name = "JobSeaExportHblEditForm";
			this.Ribbon = this.ribbonControl;
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.StatusBar = this.ribbonStatusBar1;
			this.Text = "Edit Detail HBL";
		...
		private DevExpress.XtraBars.Ribbon.RibbonPage rpHblDetailEdit;
