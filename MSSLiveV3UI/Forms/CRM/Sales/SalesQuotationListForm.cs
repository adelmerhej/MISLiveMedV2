...
namespace MISLiveMed.UI.Forms.CRM.Sales
{
    public partial class SalesQuotationListForm : RibbonForm
    {
	    private const string _formName = "SalesQuotationList";
	    private int _formId;
		...
		private void SalesQuotationListForm_FormClosing(object sender, System.Windows.Forms.FormClosingEventArgs e)
		{
			if (!_resetMenu)
			{
