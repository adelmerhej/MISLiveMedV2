...
{
    partial class MemberCategoryEditForm
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
			...
			this.bsMemberCategory = new System.Windows.Forms.BindingSource(this.components);
			...
			this.grpMemberCategory = new DevExpress.XtraLayout.LayoutControlGroup();
			...
			((System.ComponentModel.ISupportInitialize)(this.bsMemberCategory)).BeginInit();
			...
			((System.ComponentModel.ISupportInitialize)(this.grpMemberCategory)).BeginInit();
			...
			// txtId
			// 
			this.txtId.DataBindings.Add(new System.Windows.Forms.Binding("EditValue", this.bsMemberCategory, "Id", true));
			...
			// bsMemberCategory
			// 
			this.bsMemberCategory.DataSource = typeof(MemberCategoryModel);
			// 
			// chkActive
			// 
			this.chkActive.DataBindings.Add(new System.Windows.Forms.Binding("EditValue", this.bsMemberCategory, "Active", true));
			...
			// txtNotes
			// 
			this.txtNotes.DataBindings.Add(new System.Windows.Forms.Binding("EditValue", this.bsMemberCategory, "Notes", true));
			...
			// txtName
			// 
			this.txtName.DataBindings.Add(new System.Windows.Forms.Binding("EditValue", this.bsMemberCategory, "Description", true));
			...
			// grpMemberCategory
			// 
			this.grpMemberCategory.GroupStyle = DevExpress.Utils.GroupStyle.Light;
			this.grpMemberCategory.Items.AddRange(new DevExpress.XtraLayout.BaseLayoutItem[] {
            this.lblName,
			...
			this.grpMemberCategory.Location = new System.Drawing.Point(0, 0);
			this.grpMemberCategory.Name = "grpMemberCategory";
			this.grpMemberCategory.Size = new System.Drawing.Size(578, 140);
			this.grpMemberCategory.Text = "MemberCategory Info";
			// 
			// lblName
			// 
			...
			this.Name = "MemberCategoryEditForm";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Edit Member Category";
			((System.ComponentModel.ISupportInitialize)(this.mainLayout)).EndInit();
			this.mainLayout.ResumeLayout(false);
			((System.ComponentModel.ISupportInitialize)(this.txtId.Properties)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.bsMemberCategory)).EndInit();
			...
			((System.ComponentModel.ISupportInitialize)(this.grpMemberCategory)).EndInit();
        ...
        private DevExpress.XtraLayout.LayoutControlGroup grpMemberCategory;
        ...
        private System.Windows.Forms.BindingSource bsMemberCategory;
    }
}